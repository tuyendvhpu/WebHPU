         ...
         <table style="width:100%">
             <tr>
                 <td>
                     ...
                     <h2 class="h2title-detail"><a href="Khoiphongthongbao.html"> THÔNG BÁO </a></h2>
                    </div>
                 </td>
                 <td style="width: 50%">
                     <div id="search">
                         <form action="Khoiphongthongbao.html" id="searchForm" method="get">
...
$fk_congty = KillChars(ew_HtmlEncode($_GET['fk_congty']));
