         ...
         <table style="width:100%">
             <tr>
                 <td>
                     ...
                     <h2 class="h2title-detail"><a href="Khoiphonggioithieu.html"> GIỚI THIỆU  </a></h2>
                    </div>
                 </td>
                 <td style="width: 50%">
                     <div id="search">
...
<div id='content_listnotice'>
                    ...
                    <ul class="ulcontents1">
                             <?php for($k=0;$k<$rowswrk;$k++) { 
                                 ...
                                 $url ="Khoiphongchitiettintucgt-".$arwrk[$k]['PK_TINBAI_ID']."-".$obid."-".$subid."-".$fk_congty."-1-".changeTitle($arwrk[$k]['C_TITLE']).".html";          
                                  ?> 
