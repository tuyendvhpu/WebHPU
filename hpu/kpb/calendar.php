...
<div id="wrapper_thongbao">
 <div id="layout" class="clearfix">
     <div id="contenttop" class="clearfix" style="height: 100px">
          <?php include 'include/header_calendar.php' ?>
       <!-- end contenttop --></div>
       <div id="contentbody" class="clearfix">
            <div id="titlepages" style="margin:0px 7px 0px 7px;background:white">
                <h2 class="h2title-detail"> <a href="list_notice.php"> LỊCH CÔNG TÁC </a></h2>
            </div>
				...
				foreach ($arwrk as $wrk) {
					...
					$sFilterWrk .= "`PK_NGUOIDUNG_ID` = " . ew_AdjustSql(trim($wrk)) . "";
                     ...
                     switch ($array[$k]['C_STATUS_END'])
                      ...
                      // thiet lap url
                      $url = "Khoiphonglich-sukien-".$array[$k]['C_CADENLAR_ID'].".html";
