                     ...
                     <tr>
				        ...
				        <a href="http://hpu.edu.vn" title="Haiphong Private University"> <img src="../images/khoa/img_logo.png" alt="Haiphong Private University"/></a></td>
                         <td id="col2">  <h1 id="h1namehome">TRƯỜNG ĐẠI HỌC DÂN LẬP HẢI PHÒNG 
                                         <br/><a href="../kpb" title="Haiphong Private University">  <span class="spanlevel">KHỐI CÁC PHÒNG - GIỚI THIỆU</span> </a>
                         ...
                         <div id="divnavi">
				              <ul id="ulnavi">
                                                  <li><a class="active" href="Khoiphonggioithieu.html" title="Giới thiệu các phòng tại Haiphong Private University" href="home_gioithieu.php">Giới Thiệu</a></li>
