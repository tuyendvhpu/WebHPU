...
<link href="../css/khoicacphong.css" rel="stylesheet" type="text/css" media="screen,print" />
...
<?php
 ...
 else 
 {
        ...
        $title_heder ='HPU Khối Các Phòng';
        $description ='Khối Các Phòng Haiphong Private University';
 } 
...
<meta property="fb:app_id" content="172590109617907" />
</head>
<body>
<script type="text/javascript">
/* <![CDATA[ */
...
<img height="1" width="1" style="border-style:none;" alt="" src="//googleads.g.doubleclick.net/pagead/viewthroughconversion/879962061/?value=0&amp;guid=ON&amp;script=0"/>
    ...
    <?php 
        $conn = ew_Connect();
        $FK_CONGTY = 146; 
        $table1 = Check_Rootcongty(146,'PK_MACONGTY','t_congty');
        $array_donvi =  (split(",",substr(str_replace (';',',',$table1),0,-1)));
        $_SESSION['ARRAY_FK_CONGTY'] = $array_donvi;
        $_SESSION['FK_CONGTY']= "(".substr(str_replace (';',',',$table1),0,-1).")";
        $_SESSION['FK_CONGTY_EX']= "(".substr(str_replace (';',',',$table1),0,-1).")";
    ?>