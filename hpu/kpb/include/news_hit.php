           ...
           <ul class="tabs tabs-3">
                    <?php for($i=0;$i<4;$i++) { 
                         ...
                         if ($arwrk[$i]['TYPE'] == 'Tin bài')
                                 {
                                 $url ="Khoiphongchitiettintuc-".$arwrk[$i]['PK_TINBAI_ID']."-".$obid."-".$subid."-".$fk_congty."-".changeTitle($arwrk[$i]['C_TITLE']).".html";
                                 }
                                 else 
                                 {
                                 $url ="Khoiphongchitietthongbao-".$arwrk[$i]['PK_TINBAI_ID']."-".$obid."-".$subid."-".$fk_congty."-".changeTitle($arwrk[$i]['C_TITLE']).".html";   
                                 }    
                         ?> 
		<li>
