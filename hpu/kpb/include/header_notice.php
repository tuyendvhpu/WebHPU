                     ...
                     <tr>
				        ...
				        <a href="http://hpu.edu.vn" title="Haiphong Private University"> <img src="../images/khoa/img_logo.png" alt="Haiphong Private University"/></a></td>
                         <td id="col2">  <h1 id="h1namehome">TRƯỜNG ĐẠI HỌC DÂN LẬP HẢI PHÒNG 
                                         <br/> <a href="../kpb"  title="Haiphong Private University"> <span class="spanlevel">PHÒNG - THÔNG BÁO TỔNG HỢP</span> </a>
                         ...
                         <td id="col4">
                          <div id="divnavi">
				              <ul id="ulnavi">
				                  ...
				                  <li><a class="active" href="Khoiphongthongbao.html" title="Thông báo từ các phòng tại Haiphong Private University" href="#">Thông Báo</a></li>
