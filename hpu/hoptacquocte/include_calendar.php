...
<div id="wrapperlich">
    ...
    <p class="plich">
     ...
     <p class="plich">
       <a class="atittlecalendar" target="_blank" href="http://phong.hpu.edu.vn/Khoiphonglich.html">  Khối Các Phòng </a><br />
    ...
    <p class="plich pactive">
        <a class="atittlecalendar aactive" target="_blank" href="http://tv.hpu.edu.vn/TT-Thongtin-Thuvienlich.html">  Trung Tâm Thông Tin Thư Viện </a><br />  
   </p>
    <h4> Nhóm lịch </h4>
        <p class="plich">
     ...
     <h4> Tìm kiếm nhanh </h4>
                        ...
                        //   alert('The date chosen is ' + newdate);
                             window.location = "TT-Thongtin-Thuvienlich-ngay.html?date="+newdate+"";
                        }
                        </script>
