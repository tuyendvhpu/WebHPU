     ...
     <div class="sliderContainer visibleNearby fullWidth clearfix">
		  <div id="gallery-1" class="royalSlider rsDefault">   
                  <?php 
                    ...
                    $sWhereWrk = "(advertising.advertising_state = 1) AND (advertising.advertising_pos = 3) ORDER BY advertising_order DESC";
     ...
     <div id="contentbody11" class="clearfix" >
        <table id="tablecontentbody" style="width: 100%">
               <tr>
                   <?PHP
                   $conn = ew_Connect();
                    $sSqlWrk = "Select DTDOANHNGHIEP_ID,C_NAME,C_ACTIVE,C_URL,C_TYPE From t_doituong_doanhnghiep";
                    $sWhereWrk = "(t_doituong_doanhnghiep.C_ACTIVE = 1) AND (t_doituong_doanhnghiep.C_BELONGTO = 0) limit 0,4";
                    if ($sWhereWrk <> "") $sSqlWrk .= " WHERE $sWhereWrk";
                    $rswrk = $conn->Execute($sSqlWrk);
                    ...
                    { 
                           $url= "../tintuc/listnews.php?sturl=tuyensinh&pk_intro=".$arwrk[$i]['PK_DANHMUCGIOITHIEU']; 
                   ?>
                    <td style="width:25%;vertical-align:top">
                       <p class="ptextheader"> <?PHP ECHO $arwrk[$i]['C_NAME'] ?> </p>
                         <ul id="ulchuyenmuc">
                             <?php
                            $sWhereWrk ="";
                            $sSql = "Select DTDOANHNGHIEP_ID,C_NAME,C_ACTIVE,C_URL,C_TYPE From t_doituong_doanhnghiep";
                            $sWhereWrk = "(t_doituong_doanhnghiep.C_ACTIVE = 1) AND (t_doituong_doanhnghiep.C_BELONGTO = ".$arwrk[$i]['DTDOANHNGHIEP_ID'].") ORDER BY C_ORDER DESC limit 0,5";
                               ...
                               { 
                                   switch ($ar[$j]['C_TYPE']) {
                                     case 0:
                                        ...
                                        $sWhere = "(t_tinbai_levelsite.FK_EDITOR_ID=-20) AND (t_tinbai_levelsite.FK_DTDOANHNGHIEP_ID ='".$ar[$j]['DTDOANHNGHIEP_ID']."') LIMIT 1";
                                        if ($sWhere <> "") $sSql .= " WHERE $sWhere";
                                        $rs = $conn->Execute($sSql);
                                        $url_pk= "../tintuc/detailnews.php?sturl=cuusinhvien&dtdoanhnghiep_id=".$ar[$j]['DTDOANHNGHIEP_ID']."&PK_TINBAI_ID=".$rs->fields['PK_TINBAI_ID'];
                                        $taget_blank = "";
                                        break;
                                     case 1:
                                        //$url_pk= "../tintuc/listnews_ob_dn.php?sturl=doanhnghiep&dtdoanhnghiep_id=".$ar[$j]['DTDOANHNGHIEP_ID']; 
                                          $url_pk= "../tintuc/HPUDN-".$ar[$j]['DTDOANHNGHIEP_ID']."-doanhnghiep.html"; 
                                        $taget_blank = "";
                                        break;
                                     case 2:
                                        $url_pk= $ar[$j]['C_URL']; 
