         ...
         <table style="width:100%">
             <tr>
                 <td>
                     ...
                     <h2 class="h2title-detail"> <a href="Doanthetintuctonghop.html"> TIN TỨC  </a></h2>
                    </div>
                 </td>
                 <td style="width: 50%">
                     <div id="search">
                         <form action="Doanthetintuctonghop.html" id="searchForm" method="get">
...
<?php
    ...
    $sWhereWrk .= "((t_tinbai_levelsite.C_TITLE LIKE '%$keyworld%'))  AND (t_tinbai_mainlevel.FK_CONGTY IN ".$_SESSION['FK_CONGTY'].") AND ((t_doituong_levelsite.C_NAME LIKE '%Tin Tuc%'))  AND ( t_tinbai_levelsite.C_ACTIVE=1) GROUP BY t_tinbai_mainlevel.PK_TINBAI_ID ORDER BY t_tinbai_mainlevel.C_ORDER DESC LIMIT $start,$rows";
