 ...
 <div id="layout" class="clearfix">
       ...
       <div id="contentbody" class="clearfix">
            <div id="titlepages" style="margin:0px 7px 0px 7px;background:white">
                <h2 class="h2title-detail"> <a href="#">ĐẠI HỌC DÂN LẬP HẢI PHÒNG </a> - <a href="list_notice.php"> LỊCH SỰ KIỆN</a></h2>
            </div>
...
date("Y-m-d");  ;                  
 ...
 $Week = date("W");  
    ...
    $calendar_user="SELECT * FROM `t_lichcongtac` WHERE (t_lichcongtac.C_ACTIVE = '1')  AND (t_lichcongtac.C_CADENLAR_ID = '".$eventid."') "; 
