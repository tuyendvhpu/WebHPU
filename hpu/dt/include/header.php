...
<link href="../css/doanthe.css" rel="stylesheet" type="text/css" media="screen,print" />
...
<?php
 ...
 else 
 {
        ...
        $title_heder ='Đoàn Thể';
        $description ='Đoàn Thể';
 } 
...
<meta property="fb:app_id" content="220841131429435" />
...
<img height="1" width="1" style="border-style:none;" alt="" src="//googleads.g.doubleclick.net/pagead/viewthroughconversion/879962061/?value=0&amp;guid=ON&amp;script=0"/>
    ...
    <?php 
        $conn = ew_Connect();
        $FK_CONGTY = 160; 
        $table1 = Check_Rootcongty(160,'PK_MACONGTY','t_congty');
