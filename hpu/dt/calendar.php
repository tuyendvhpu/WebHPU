				...
				foreach ($arwrk as $wrk) {
					...
					$sFilterWrk .= "`PK_NGUOIDUNG_ID` = " . ew_AdjustSql(trim($wrk)) . "";
                     ...
                     switch ($array[$k]['C_STATUS_END'])
                      ...
                      // thiet lap url
                      $url = "Doanthelich-sukien-".$array[$k]['C_CADENLAR_ID'].".html";
                                ...
                                <tr>
                                    <td style="width:290px"><a class="calender_title" href="<?php echo $url ?>"> <SPAN class="spanc_thoigian"><?php echo $t_lichcongtac->C_THOIGIAN->ViewValue1 ?></SPAN>&nbsp;<?php echo $array[$k]['C_TITLE'] ?> </a></td>
                                 ...
                                 <?php
                                        ...
                                        // C_PARTICIPANTS_ID             
                                              ...
                                              <?php if (($array[$k]['C_HOUR_START'] > 12) && ($array[$k]['C_HOUR_START'] <=24))
                                                                    {  ?>
                                <tr>
                                    <td style="width:290px"><a class="calender_title" href="<?php echo $url ?>"><?php echo  $t_lichcongtac->C_THOIGIAN->ViewValue1." ".$array[$k]['C_TITLE'] ?> </a></td>
                                    <td style="width:70px"><span class="spantext"> <?php echo  $t_lichcongtac->FK_CONGTY->ViewValue1   ?></span></td>
                                    <td style="width:170px"><span class="spantext"><?php echo $t_lichcongtac->C_PARTICIPANTS_ID->ViewValue1 ?></span></td>
                                     <td style="width:120px"><span class="spantext"><?php echo $array[$k]['C_WHERE'] ?></span></td>
                                </tr>
