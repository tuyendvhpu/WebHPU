...
<div id="wrapperlich">
    ...
    <p class="plich pactive">
        ...
        <a class="atittlecalendar aactive" target="_blank" href="http://qt.hpu.edu.vn/QTlich.html">  Khoa Quản Trị Kinh Doanh </a><br />
    ...
    <h4> Nhóm lịch </h4>
     ...
     <h4> Tìm kiếm nhanh </h4>
                        ...
                        //   alert('The date chosen is ' + newdate);
                         window.location = "QTlich-ngay.html?date="+newdate+"";
                        }
                        </script>
