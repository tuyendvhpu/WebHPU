         ...
         <table style="width:100%">
             ...
             <tr>
                 <td>
                     ...
                     <?php $url  = "GDTCthongbaodt-".KillChars(ew_HtmlEncode($_GET['obid'])).".html"; ?>    
                     <h2 class="h2title-detail"><a href="-<?php echo $url ?>"> THÔNG BÁO </a></h2>
                    </div>
                 </td>
                 <td style="width: 50%">
                     <div id="search">
                         <form action="GDTCthongbaodttimkiem.html" id="searchForm" method="get">
         ...
         <h2 class="h2title"> </h2>            
                    <ul class="ulcontents1">
                             <?php for($k=0;$k<$rowswrk;$k++) { 
                                   $url ="GDTCthongbao-".$arwrk[$k]['PK_THONGBAO']."-".changeTitle($arwrk[$k]['C_TITLE']).".html";          
                                  ?> 
                             <li> <a class="pjaxer" id="titlereport" href="<?php echo $url ?>">  <?php echo $arwrk[$k]['C_TITLE'] ?>
                                     <br>
                                     <span class="datetime"> GDTC - Thời gian: từ <?php echo date( 'j/m/Y',strtotime($arwrk[$k]['C_BEGIN_DATE'])) ?> - <?php echo  date( 'j/m/Y',strtotime($arwrk[$k]['C_END_DATE'])) ?> </span>
                                 </a> 
                             </li>    
                              <?php } ?>    
                      </ul>
