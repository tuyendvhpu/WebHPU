...
<div id="wrapperlich">
    ...
    <p class="plich pactive">
        ...
        <a class="atittlecalendar aactive" target="_blank" href="http://gdtc.hpu.edu.vn/GDTClich.html">  Bộ Môn Giáo Dục Thể Chất </a><br />
    ...
    <h4> Nhóm lịch </h4>
     ...
     <h4> Tìm kiếm nhanh </h4>
                        ...
                        //   alert('The date chosen is ' + newdate);
                         window.location = "GDTClich-ngay.html?date="+newdate+"";
                        }
                        </script>
