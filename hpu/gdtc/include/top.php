              ...
              <table id="tableheader">
                     <tr>
                         ...
                         <td id="col2">  <h1 id="h1namehome"> <span class="spanlevel_home"> TRƯỜNG ĐẠI HỌC DÂN LẬP HẢI PHÒNG 
                                         <br/> <a href="../GDTC/GDTCtrangchu.html" title="Haiphong Private University - BỘ MÔN GIÁO DỤC THỂ CHẤT">  <span class="spanlevel">BỘ MÔN GIÁO DỤC THỂ CHẤT</span> </a>
                          ...
                          <div id="divnavi">
				              <ul id="ulnavi"> 
                                                 <?php for($i=0;$i<$rowswrk;$i++) {
                                                      $url= "GDTCchuyenmuc-".$arwrk[$i]['PK_CHUYENMUC']."-".changeTitle($arwrk[$i]['C_NAME']).".html";
