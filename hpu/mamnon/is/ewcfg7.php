...
define("EW_PROJECT_NAME", "ismamnon", TRUE); // Project name
define("EW_RANDOM_KEY", '4hzNt4cuxwo9nktI', TRUE); // Random key for encryption
define("EW_PROJECT_STYLESHEET_FILENAME", "ismamnon.css", TRUE); // Project stylesheet file name
