              ...
              <table id="tableheader">
                     <tr>
                         ...
                         <td id="col2">  <h1 id="h1namehome"> <span class="spanlevel_home"> TRƯỜNG ĐẠI HỌC DÂN LẬP HẢI PHÒNG 
                                         <br/> <a href="../CBCS/CBCStrangchu.html" title="Haiphong Private University - BỘ MÔN CƠ BẢN CƠ SỞ">  <span class="spanlevel">BỘ MÔN CƠ BẢN CƠ SỞ</span> </a>
                          ...
                          <div id="divnavi">
				              <ul id="ulnavi"> 
                                                 <?php for($i=0;$i<$rowswrk;$i++) { 
                                                  $url= "CBCSchuyenmuc-".$arwrk[$i]['PK_CHUYENMUC']."-".changeTitle($arwrk[$i]['C_NAME']).".html";
