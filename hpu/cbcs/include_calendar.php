...
<div id="wrapperlich">
    ...
    <p class="plich pactive">
        ...
        <a class="atittlecalendar aactive" target="_blank" href="http://cbcs.hpu.edu.vn/CBCSlich.html">  Bộ Môn Bản Cơ Sở </a><br />
    ...
    <h4> Nhóm lịch </h4>
     ...
     <h4> Tìm kiếm nhanh </h4>
                        ...
                        //   alert('The date chosen is ' + newdate);
                         window.location = "CBCSlich-ngay.html?date="+newdate+"";
                        }
                        </script>
