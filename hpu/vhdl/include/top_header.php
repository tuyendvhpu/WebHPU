              ...
              <table id="tableheader">
                     <tr>
                         ...
                         <td id="col2">  <h1 id="h1namehome"> <span class="spanlevel_home"> TRƯỜNG ĐẠI HỌC DÂN LẬP HẢI PHÒNG 
                                         <br/> <a href="http://vhdl.hpu.edu.vn" title="Haiphong Private University - KHOA DU LỊCH">  <span class="spanlevel">KHOA DU LỊCH</span> </a>
                          ...
                          <div id="divnavi">
				              <ul id="ulnavi"> 
                                                 <?php for($i=0;$i<$rowswrk;$i++) { 
                                                  $url= "VHDLchuyenmuc-".$arwrk[$i]['PK_CHUYENMUC']."-".changeTitle($arwrk[$i]['C_NAME']).".html";
