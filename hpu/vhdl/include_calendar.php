...
<div id="wrapperlich">
    ...
    <p class="plich pactive">
        ...
        <a class="atittlecalendar aactive" target="_blank" href="http://vhdl.hpu.edu.vn/VHDLlich.html">  KHOA DU LỊCH </a><br />
    ...
    <h4> Nhóm lịch </h4>
     ...
     <h4> Tìm kiếm nhanh </h4>
                        ...
                        //   alert('The date chosen is ' + newdate);
                            window.location = "VHDLlich-ngay.html?date="+newdate+"";
                        }
                        </script>
