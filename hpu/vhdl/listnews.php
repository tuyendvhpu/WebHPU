             ...
             <tr>
                 <td>
                     <div id="titlepages" style="margin:0px 7px 0px 7px;background:white">
                         <?php     $url= "VHDLchuyenmuc-".$subid."-".changeTitle($arwrk[$i]['C_NAME']).".html" ?>
                     <h2 class="h2title-detail"> <a href="<?php $url ?>"><?php echo $tittle_string; ?>  </a></h2>
                    </div>
                 </td>
                 <td style="width: 50%">
                     <div id="search">
                         <form action="VHDLchuyenmuc.html" id="searchForm" method="get">
...
<div id='content_listnotice'>
                    ...
                    <ul class="ulcontents1">
                             <?php for($k=0;$k<$rowswrk;$k++) { 
                                  ...
                                  $url ="VHDLtintuc-".$arwrk[$k]['PK_TINBAI_ID']."-".$obid."-".$subid."-0-".changeTitle($arwrk[$k]['C_TITLE']).".html";          
                                  ?> 
