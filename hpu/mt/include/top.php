              ...
              <table id="tableheader">
                     <tr>
                         ...
                         <td id="col2">  <h1 id="h1namehome"> <span class="spanlevel_home"> TRƯỜNG ĐẠI HỌC DÂN LẬP HẢI PHÒNG 
                                         <br/> <a href="../MT/MTtrangchu.html" title="Haiphong Private University - KHOA MÔI TRƯỜNG">  <span class="spanlevel">KHOA MÔI TRƯỜNG</span> </a>
                          ...
                          <div id="divnavi">
				              <ul id="ulnavi"> 
                                                 <?php for($i=0;$i<$rowswrk;$i++) {
                                                      $url= "MTchuyenmuc-".$arwrk[$i]['PK_CHUYENMUC']."-".changeTitle($arwrk[$i]['C_NAME']).".html";
