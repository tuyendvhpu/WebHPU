...
<div >
<div style="background:url('images/img_bglogin.jpg') no-repeat;border:1px slategray solid;height:550px;">
    <a href="../map/uni/home/index.php?" style="border: none;width:209px;height: 263px;float: right;margin-right:70px;margin-top: 70px;"></a>
...
<form action="<?php echo ew_CurrentPage() ?>" method="post" onsubmit="return login.ValidateForm(this);">
    <table border="0" cellspacing="0" cellpadding="2" style="margin-top: 130px;margin-left: 180px">
	<tr>
            <td><span class="phpmaker"><strong><?php echo $Language->Phrase("Username") ?>: </strong></span></td>
		<td><span class="phpmaker"><input type="text" name="username" id="username" size="30" value="<?php echo $login->Username ?>"></span></td>
	</tr>
	<tr>
		<td><span class="phpmaker"><strong><?php echo $Language->Phrase("Password") ?>: </strong></span></td>
		<td><span class="phpmaker"><input type="password" name="password" id="password" size="30"></span></td>
	</tr>
        <tr>
		<td>&nbsp;</td>
                <td>
                    <p style="float: left;"><label><input type="radio" name="rememberme" id="rememberme" value="a"<?php if ($login->LoginType == "a") { ?> checked="checked"<?php } ?>><?php echo $Language->Phrase("AutoLogin") ?></label></p>
		...
		<td>&nbsp;</td>
                <td>
                    <p style="float: left;margin-top: -10px;"> <label><input type="radio" name="rememberme" id="rememberme" value="u"<?php if ($login->LoginType == "u") { ?>  checked="checked"<?php } ?>><?php echo $Language->Phrase("SaveUserName") ?></label></p>
		</td>
	</tr>
        <tr >
		<td>&nbsp;</td>
                <td>
                    <p style="float: left;margin-top: -10px;"> <label><input type="radio" name="rememberme" id="rememberme" value=""<?php if ($login->LoginType == "") { ?> checked="checked"<?php } ?>><?php echo $Language->Phrase("AlwaysAsk") ?></label></p>
		</td>
	</tr>
	<tr>
		<td colspan="2" align="center"><span class="phpmaker"><input type="submit" name="submit" id="submit" value="Đăng nhập"></span></td>
	</tr>
</table>
</form>
<br>
<p style="margin-left:348px;margin-top: -5px;"><span class="phpmaker">
