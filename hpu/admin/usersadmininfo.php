...
//
// Table class for usersadmin
//
class cusersadmin {
	var $TableVar = 'usersadmin';
	...
	function cusersadmin() {
		...
		// PK_NGUOIDUNG_ID
		$this->PK_NGUOIDUNG_ID = new cField('usersadmin', 'usersadmin', 'x_PK_NGUOIDUNG_ID', 'PK_NGUOIDUNG_ID', 't_nguoidung.PK_NGUOIDUNG_ID', 3, -1, FALSE, 't_nguoidung.PK_NGUOIDUNG_ID', FALSE);
		$this->PK_NGUOIDUNG_ID->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['PK_NGUOIDUNG_ID'] =& $this->PK_NGUOIDUNG_ID;

		// C_TENDANGNHAP
		$this->C_TENDANGNHAP = new cField('usersadmin', 'usersadmin', 'x_C_TENDANGNHAP', 'C_TENDANGNHAP', 't_nguoidung.C_TENDANGNHAP', 200, -1, FALSE, 't_nguoidung.C_TENDANGNHAP', FALSE);
		$this->fields['C_TENDANGNHAP'] =& $this->C_TENDANGNHAP;

		// C_MATKHAU
		$this->C_MATKHAU = new cField('usersadmin', 'usersadmin', 'x_C_MATKHAU', 'C_MATKHAU', 't_nguoidung.C_MATKHAU', 200, -1, FALSE, 't_nguoidung.C_MATKHAU', FALSE);
		$this->fields['C_MATKHAU'] =& $this->C_MATKHAU;

		// FK_MACONGTY
		$this->FK_MACONGTY = new cField('usersadmin', 'usersadmin', 'x_FK_MACONGTY', 'FK_MACONGTY', 't_nguoidung.FK_MACONGTY', 3, -1, FALSE, 't_nguoidung.FK_MACONGTY', FALSE);
		$this->FK_MACONGTY->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['FK_MACONGTY'] =& $this->FK_MACONGTY;

		// C_HOTEN
		$this->C_HOTEN = new cField('usersadmin', 'usersadmin', 'x_C_HOTEN', 'C_HOTEN', 't_nguoidung.C_HOTEN', 200, -1, FALSE, 't_nguoidung.C_HOTEN', FALSE);
		$this->fields['C_HOTEN'] =& $this->C_HOTEN;

		// C_DIACHI
		$this->C_DIACHI = new cField('usersadmin', 'usersadmin', 'x_C_DIACHI', 'C_DIACHI', 't_nguoidung.C_DIACHI', 200, -1, FALSE, 't_nguoidung.C_DIACHI', FALSE);
		$this->fields['C_DIACHI'] =& $this->C_DIACHI;

		// C_TEL
		$this->C_TEL = new cField('usersadmin', 'usersadmin', 'x_C_TEL', 'C_TEL', 't_nguoidung.C_TEL', 200, -1, FALSE, 't_nguoidung.C_TEL', FALSE);
		$this->fields['C_TEL'] =& $this->C_TEL;

		// C_TEL_HOME
		$this->C_TEL_HOME = new cField('usersadmin', 'usersadmin', 'x_C_TEL_HOME', 'C_TEL_HOME', 't_nguoidung.C_TEL_HOME', 200, -1, FALSE, 't_nguoidung.C_TEL_HOME', FALSE);
		$this->fields['C_TEL_HOME'] =& $this->C_TEL_HOME;

		// C_TEL_MOBILE
		$this->C_TEL_MOBILE = new cField('usersadmin', 'usersadmin', 'x_C_TEL_MOBILE', 'C_TEL_MOBILE', 't_nguoidung.C_TEL_MOBILE', 200, -1, FALSE, 't_nguoidung.C_TEL_MOBILE', FALSE);
		$this->fields['C_TEL_MOBILE'] =& $this->C_TEL_MOBILE;

		// C_FAX
		$this->C_FAX = new cField('usersadmin', 'usersadmin', 'x_C_FAX', 'C_FAX', 't_nguoidung.C_FAX', 200, -1, FALSE, 't_nguoidung.C_FAX', FALSE);
		$this->fields['C_FAX'] =& $this->C_FAX;

		// C_EMAIL
		$this->C_EMAIL = new cField('usersadmin', 'usersadmin', 'x_C_EMAIL', 'C_EMAIL', 't_nguoidung.C_EMAIL', 200, -1, FALSE, 't_nguoidung.C_EMAIL', FALSE);
		$this->fields['C_EMAIL'] =& $this->C_EMAIL;

		// FK_USERLEVELID
		$this->FK_USERLEVELID = new cField('usersadmin', 'usersadmin', 'x_FK_USERLEVELID', 'FK_USERLEVELID', 't_nguoidung.FK_USERLEVELID', 3, -1, FALSE, 't_nguoidung.FK_USERLEVELID', FALSE);
	...
	function SqlWhere() { // Where
		$sWhere = "t_nguoidung.FK_MACONGTY = 0 and t_nguoidung.FK_USERLEVELID not in (-1,0)";
		$this->TableFilter = "";
		if ($this->TableFilter <> "") {
