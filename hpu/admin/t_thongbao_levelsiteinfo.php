...
$t_thongbao_levelsite = NULL;

//
// Table class for t_thongbao_levelsite
//
class ct_thongbao_levelsite {
	var $TableVar = 't_thongbao_levelsite';
	...
	//
	function ct_thongbao_levelsite() {
		global $Language;

		// PK_THONGBAO
		$this->PK_THONGBAO = new cField('t_thongbao_levelsite', 't_thongbao_levelsite', 'x_PK_THONGBAO', 'PK_THONGBAO', '`PK_THONGBAO`', 3, -1, FALSE, '`PK_THONGBAO`', FALSE);
		$this->PK_THONGBAO->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['PK_THONGBAO'] =& $this->PK_THONGBAO;

		// FK_CONGTY_ID
		$this->FK_CONGTY_ID = new cField('t_thongbao_levelsite', 't_thongbao_levelsite', 'x_FK_CONGTY_ID', 'FK_CONGTY_ID', '`FK_CONGTY_ID`', 3, -1, FALSE, '`FK_CONGTY_ID`', FALSE);
		$this->FK_CONGTY_ID->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['FK_CONGTY_ID'] =& $this->FK_CONGTY_ID;

		// FK_DOITUONG_ID
		$this->FK_DOITUONG_ID = new cField('t_thongbao_levelsite', 't_thongbao_levelsite', 'x_FK_DOITUONG_ID', 'FK_DOITUONG_ID', '`FK_DOITUONG_ID`', 3, -1, FALSE, '`FK_DOITUONG_ID`', FALSE);
		$this->FK_DOITUONG_ID->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['FK_DOITUONG_ID'] =& $this->FK_DOITUONG_ID;

		// C_TITLE
		$this->C_TITLE = new cField('t_thongbao_levelsite', 't_thongbao_levelsite', 'x_C_TITLE', 'C_TITLE', '`C_TITLE`', 200, -1, FALSE, '`C_TITLE`', FALSE);
		$this->fields['C_TITLE'] =& $this->C_TITLE;

		// C_CONTENT
		$this->C_CONTENT = new cField('t_thongbao_levelsite', 't_thongbao_levelsite', 'x_C_CONTENT', 'C_CONTENT', '`C_CONTENT`', 201, -1, FALSE, '`C_CONTENT`', FALSE);
		$this->C_CONTENT->TruncateMemoRemoveHtml = TRUE;
		$this->fields['C_CONTENT'] =& $this->C_CONTENT;

		// C_PUBLISH
		$this->C_PUBLISH = new cField('t_thongbao_levelsite', 't_thongbao_levelsite', 'x_C_PUBLISH', 'C_PUBLISH', '`C_PUBLISH`', 3, -1, FALSE, '`C_PUBLISH`', FALSE);
		$this->C_PUBLISH->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['C_PUBLISH'] =& $this->C_PUBLISH;

		// C_ACTIVE
		$this->C_ACTIVE = new cField('t_thongbao_levelsite', 't_thongbao_levelsite', 'x_C_ACTIVE', 'C_ACTIVE', '`C_ACTIVE`', 3, -1, FALSE, '`C_ACTIVE`', FALSE);
		$this->C_ACTIVE->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['C_ACTIVE'] =& $this->C_ACTIVE;

		// C_BEGIN_DATE
		$this->C_BEGIN_DATE = new cField('t_thongbao_levelsite', 't_thongbao_levelsite', 'x_C_BEGIN_DATE', 'C_BEGIN_DATE', '`C_BEGIN_DATE`', 135, 7, FALSE, '`C_BEGIN_DATE`', FALSE);
		...
		// C_END_DATE
		$this->C_END_DATE = new cField('t_thongbao_levelsite', 't_thongbao_levelsite', 'x_C_END_DATE', 'C_END_DATE', '`C_END_DATE`', 135, 7, FALSE, '`C_END_DATE`', FALSE);
		$this->C_END_DATE->FldDefaultErrMsg = str_replace("%s", "/", $Language->Phrase("IncorrectDateDMY"));
		$this->fields['C_END_DATE'] =& $this->C_END_DATE;

		// C_ORDER
		$this->C_ORDER = new cField('t_thongbao_levelsite', 't_thongbao_levelsite', 'x_C_ORDER', 'C_ORDER', '`C_ORDER`', 135, 7, FALSE, '`C_ORDER`', FALSE);
		$this->C_ORDER->FldDefaultErrMsg = str_replace("%s", "/", $Language->Phrase("IncorrectDateDMY"));
		$this->fields['C_ORDER'] =& $this->C_ORDER;

		// C_USER_ADD
		$this->C_USER_ADD = new cField('t_thongbao_levelsite', 't_thongbao_levelsite', 'x_C_USER_ADD', 'C_USER_ADD', '`C_USER_ADD`', 3, -1, FALSE, '`C_USER_ADD`', FALSE);
		$this->C_USER_ADD->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['C_USER_ADD'] =& $this->C_USER_ADD;

		// C_ADD_TIME
		$this->C_ADD_TIME = new cField('t_thongbao_levelsite', 't_thongbao_levelsite', 'x_C_ADD_TIME', 'C_ADD_TIME', '`C_ADD_TIME`', 135, 7, FALSE, '`C_ADD_TIME`', FALSE);
		$this->C_ADD_TIME->FldDefaultErrMsg = str_replace("%s", "/", $Language->Phrase("IncorrectDateDMY"));
		$this->fields['C_ADD_TIME'] =& $this->C_ADD_TIME;

		// C_USER_EDIT
		$this->C_USER_EDIT = new cField('t_thongbao_levelsite', 't_thongbao_levelsite', 'x_C_USER_EDIT', 'C_USER_EDIT', '`C_USER_EDIT`', 3, -1, FALSE, '`C_USER_EDIT`', FALSE);
		$this->C_USER_EDIT->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['C_USER_EDIT'] =& $this->C_USER_EDIT;

		// C_EDIT_TIME
		$this->C_EDIT_TIME = new cField('t_thongbao_levelsite', 't_thongbao_levelsite', 'x_C_EDIT_TIME', 'C_EDIT_TIME', '`C_EDIT_TIME`', 135, 7, FALSE, '`C_EDIT_TIME`', FALSE);
		$this->C_EDIT_TIME->FldDefaultErrMsg = str_replace("%s", "/", $Language->Phrase("IncorrectDateDMY"));
		$this->fields['C_EDIT_TIME'] =& $this->C_EDIT_TIME;

		// FK_NGUOIDUNG_ID
		$this->FK_NGUOIDUNG_ID = new cField('t_thongbao_levelsite', 't_thongbao_levelsite', 'x_FK_NGUOIDUNG_ID', 'FK_NGUOIDUNG_ID', '`FK_NGUOIDUNG_ID`', 3, -1, FALSE, '`FK_NGUOIDUNG_ID`', FALSE);
		$this->FK_NGUOIDUNG_ID->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['FK_NGUOIDUNG_ID'] =& $this->FK_NGUOIDUNG_ID;
                
                // C_TIME_PUBLISH
		$this->C_TIME_PUBLISH = new cField('t_thongbao_levelsite', 't_thongbao_levelsite', 'x_C_TIME_PUBLISH', 'C_TIME_PUBLISH', '`C_TIME_PUBLISH`', 135, 7, FALSE, '`C_TIME_PUBLISH`', FALSE);
		...
		$this->fields['C_TIME_PUBLISH'] =& $this->C_TIME_PUBLISH;
                ...
                // FK_ARRAY_CONGTY
		$this->FK_ARRAY_CONGTY = new cField('t_thongbao_levelsite', 't_thongbao_levelsite', 'x_FK_ARRAY_CONGTY', 'FK_ARRAY_CONGTY', '`FK_ARRAY_CONGTY`', 200, -1, FALSE, '`FK_ARRAY_CONGTY`', FALSE);
		$this->fields['FK_ARRAY_CONGTY'] =& $this->FK_ARRAY_CONGTY;

		// C_KEYWORD
		$this->C_KEYWORD = new cField('t_thongbao_levelsite', 't_thongbao_levelsite', 'x_C_KEYWORD', 'C_KEYWORD', '`C_KEYWORD`', 200, -1, FALSE, '`C_KEYWORD`', FALSE);
		$this->fields['C_KEYWORD'] =& $this->C_KEYWORD;
                
		// C_NOTICE_HIT
		$this->C_NOTICE_HIT = new cField('t_thongbao_levelsite', 't_thongbao_levelsite', 'x_C_NOTICE_HIT', 'C_NOTICE_HIT', '`C_NOTICE_HIT`', 3, -1, FALSE, '`C_NOTICE_HIT`', FALSE);
		$this->C_NOTICE_HIT->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['C_NOTICE_HIT'] =& $this->C_NOTICE_HIT;
                
                // PK_CHUYENMUC_ID
		$this->PK_CHUYENMUC_ID = new cField('t_thongbao_levelsite', 't_thongbao_levelsite', 'x_PK_CHUYENMUC_ID', 'PK_CHUYENMUC_ID', '`PK_CHUYENMUC_ID`', 3, -1, FALSE, '`PK_CHUYENMUC_ID`', FALSE);
		$this->PK_CHUYENMUC_ID->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['PK_CHUYENMUC_ID'] =& $this->PK_CHUYENMUC_ID;
                
                // C_FILEANH
		$this->C_FILEANH = new cField('t_thongbao_levelsite', 't_thongbao_levelsite', 'x_C_FILEANH', 'C_FILEANH', '`C_FILEANH`', 200, -1, FALSE, '`C_FILEANH`', FALSE);
	...
	function HighlightName() {
		return "t_thongbao_levelsite_Highlight";
	}
	...
	function SqlWhere() { // Where
		...
		$sWhere = "";
                  if (IsAdmin()) $sWhere ="";
                  else $sWhere = "t_thongbao_levelsite.FK_CONGTY_ID = ".$Security->CurrentUserOption();
		$this->TableFilter = "";
		if ($this->TableFilter <> "") {
	...
	function InsertSQL(&$rs) {
		...
		return "INSERT INTO `t_thongbao_levelsite` ($names) VALUES ($values)";
	}

	// UPDATE statement
	function UpdateSQL(&$rs) {
		global $conn;
		$SQL = "UPDATE `t_thongbao_levelsite` SET ";
		foreach ($rs as $name => $value) {
	...
	function DeleteSQL(&$rs) {
		$SQL = "DELETE FROM `t_thongbao_levelsite` WHERE ";
	...
	function getReturnUrl() {
		...
		if (@$_SESSION[$name] <> "") {
			...
			return "t_thongbao_levelsitelist.php";
		}
	}
	...
	// View URL
	function ViewUrl() {
		return $this->KeyUrl("t_thongbao_levelsiteview.php", $this->UrlParm());
	}

	// Add URL
	function AddUrl() {
		$AddUrl = "t_thongbao_levelsiteadd.php";
	...
	// Edit URL
	function EditUrl() {
		return $this->KeyUrl("t_thongbao_levelsiteedit.php", $this->UrlParm());
	}
	...
	// Copy URL
	function CopyUrl() {
		return $this->KeyUrl("t_thongbao_levelsiteadd.php", $this->UrlParm());
	}
	...
	// Delete URL
	function DeleteUrl() {
		return $this->KeyUrl("t_thongbao_levelsitedelete.php", $this->UrlParm());
	}
	...
	function UrlParm($parm = "") {
		$UrlParm = ($this->UseTokenInUrl) ? "t=t_thongbao_levelsite" : "";
		if ($parm <> "") {
			if ($UrlParm <> "")
				$UrlParm .= "&";
			$UrlParm .= $parm;
   ...
   // Common render codes
		...
		if (strval($this->C_PUBLISH->CurrentValue) <> "") {
			switch ($this->C_PUBLISH->CurrentValue) {
				case "0":
					$this->C_PUBLISH->ViewValue = "Khong active Mainsite";
					break;
				case "1":
					$this->C_PUBLISH->ViewValue = "Active len Mainsite";
					break;
				default:
