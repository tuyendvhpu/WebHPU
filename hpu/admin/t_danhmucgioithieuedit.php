...
// Create page object
$t_danhmucgioithieu_edit = new ct_danhmucgioithieu_edit();
$Page =& $t_danhmucgioithieu_edit;

// Page init
$t_danhmucgioithieu_edit->Page_Init();

// Page main
$t_danhmucgioithieu_edit->Page_Main();
?>
...
// Create page object
var t_danhmucgioithieu_edit = new ew_Page("t_danhmucgioithieu_edit");

// page properties
t_danhmucgioithieu_edit.PageID = "edit"; // page ID
t_danhmucgioithieu_edit.FormID = "ft_danhmucgioithieuedit"; // form ID
var EW_PAGE_ID = t_danhmucgioithieu_edit.PageID; // for backward compatibility

// extend page with ValidateForm function
t_danhmucgioithieu_edit.ValidateForm = function(fobj) {
...
t_danhmucgioithieu_edit.Form_CustomValidate =  
 function(fobj) { // DO NOT CHANGE THIS LINE!

 	// Your custom validation code here, return false if invalid. 
 	return true;
 }
t_danhmucgioithieu_edit.SelectAllKey = function(elem) {
	ew_SelectAll(elem);
	ew_ClickAll(elem);
}
<?php if (EW_CLIENT_VALIDATE) { ?>
t_danhmucgioithieu_edit.ValidateRequired = true; // uses JavaScript validation
<?php } else { ?>
t_danhmucgioithieu_edit.ValidateRequired = false; // no JavaScript validation
<?php } ?>
...
<p class="pheader"><span class="phpmaker"><?php echo $t_danhmucgioithieu->TableCaption() ?></p>
<a href="<?php echo $t_danhmucgioithieu->getReturnUrl() ?>"><?php echo $Language->Phrase("GoBack") ?></a>
<?php
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
$t_danhmucgioithieu_edit->ShowMessage();
?>
<form name="ft_danhmucgioithieuedit" id="ft_danhmucgioithieuedit" action="<?php echo ew_CurrentPage() ?>" method="post" onsubmit="return t_danhmucgioithieu_edit.ValidateForm(this);">
<p>
<input type="hidden" name="a_table" id="a_table" value="t_danhmucgioithieu">
...
<input type="text" name="x_C_NAME" id="x_C_NAME" title="<?php echo $t_danhmucgioithieu->C_NAME->FldTitle() ?>" size="30" maxlength="255" value="<?php echo $t_danhmucgioithieu->C_NAME->EditValue ?>"<?php echo $t_danhmucgioithieu->C_NAME->EditAttributes() ?>>
...
<textarea name="x_C_DESCRIPTION" id="x_C_DESCRIPTION" title="<?php echo $t_danhmucgioithieu->C_DESCRIPTION->FldTitle() ?>" cols="35" rows="4"<?php echo $t_danhmucgioithieu->C_DESCRIPTION->EditAttributes() ?>><?php echo $t_danhmucgioithieu->C_DESCRIPTION->EditValue ?></textarea>
...
<input type="hidden" name="x_PK_DANHMUCGIOITHIEU" id="x_PK_DANHMUCGIOITHIEU" value="<?php echo ew_HtmlEncode($t_danhmucgioithieu->PK_DANHMUCGIOITHIEU->CurrentValue) ?>">
<p>
...
<?php
$t_danhmucgioithieu_edit->Page_Terminate();
?>
<?php
...
// Page class
//
class ct_danhmucgioithieu_edit {
	...
	// Page object name
	var $PageObjName = 't_danhmucgioithieu_edit';
	...
	//
	function ct_danhmucgioithieu_edit() {
	...
	function Page_Main() {
		...
		if (@$_POST["a_edit"] <> "") {
			$t_danhmucgioithieu->CurrentAction = $_POST["a_edit"]; // Get action code
			$this->LoadFormValues(); // Get form values

			// Validate form
			if (!$this->ValidateForm()) {
				$t_danhmucgioithieu->CurrentAction = ""; // Form error, reset action
				$this->setMessage($gsFormError);
				$t_danhmucgioithieu->EventCancelled = TRUE; // Event cancelled
				$this->RestoreFormValues();
			}
		} else {
			$t_danhmucgioithieu->CurrentAction = "I"; // Default action is display
		}

		// Check if valid key
		if ($t_danhmucgioithieu->PK_DANHMUCGIOITHIEU->CurrentValue == "")
			$this->Page_Terminate("t_danhmucgioithieulist.php"); // Invalid key, return to list
		switch ($t_danhmucgioithieu->CurrentAction) {
			case "I": // Get a record to display
				...
				break;
			Case "U": // Update
				$t_danhmucgioithieu->SendEmail = TRUE; // Send email on update success
				if ($this->EditRow()) { // Update record based on key
					$this->setMessage($Language->Phrase("UpdateSuccess")); // Update success
					$sReturnUrl = $t_danhmucgioithieu->getReturnUrl();
					if (ew_GetPageName($sReturnUrl) == "t_danhmucgioithieuview.php")
						$sReturnUrl = $t_danhmucgioithieu->ViewUrl(); // View paging, return to View page directly
		...
		// Render the record
		$t_danhmucgioithieu->RowType = EW_ROWTYPE_EDIT; // Render as Edit
		$this->RenderRow();
	}
	...
	function LoadFormValues() {
		...
		$t_danhmucgioithieu->C_USER_EDIT->setFormValue($objForm->GetValue("x_C_USER_EDIT"));
		$t_danhmucgioithieu->C_EDIT_TIME->setFormValue($objForm->GetValue("x_C_EDIT_TIME"));
		$t_danhmucgioithieu->C_EDIT_TIME->CurrentValue = ew_UnFormatDateTime($t_danhmucgioithieu->C_EDIT_TIME->CurrentValue, 7);
	...
	function RestoreFormValues() {
		...
		$t_danhmucgioithieu->C_USER_EDIT->CurrentValue = $t_danhmucgioithieu->C_USER_EDIT->FormValue;
		$t_danhmucgioithieu->C_EDIT_TIME->CurrentValue = $t_danhmucgioithieu->C_EDIT_TIME->FormValue;
		$t_danhmucgioithieu->C_EDIT_TIME->CurrentValue = ew_UnFormatDateTime($t_danhmucgioithieu->C_EDIT_TIME->CurrentValue, 7);
	}
	...
	function RenderRow() {
		...
		} elseif ($t_danhmucgioithieu->RowType == EW_ROWTYPE_EDIT) { // Edit row
	...
	function EditRow() {
		...
		if ($rs->EOF) {
			...
			// C_USER_EDIT
			$t_danhmucgioithieu->C_USER_EDIT->SetDbValueDef($rsnew, CurrentUserID(), NULL);
			$rsnew['C_USER_EDIT'] =& $t_danhmucgioithieu->C_USER_EDIT->DbValue;

			// C_EDIT_TIME
			$t_danhmucgioithieu->C_EDIT_TIME->SetDbValueDef($rsnew, ew_CurrentDateTime(), NULL);
			$rsnew['C_EDIT_TIME'] =& $t_danhmucgioithieu->C_EDIT_TIME->DbValue;

			// Call Row Updating event
			$bUpdateRow = $t_danhmucgioithieu->Row_Updating($rsold, $rsnew);
			if ($bUpdateRow) {
				$conn->raiseErrorFn = 'ew_ErrorFn';
				$EditRow = $conn->Execute($t_danhmucgioithieu->UpdateSQL($rsnew));
				$conn->raiseErrorFn = '';
			} else {
		...
		if ($EditRow)
			$t_danhmucgioithieu->Row_Updated($rsold, $rsnew);
		$rs->Close();
		return $EditRow;
	}
