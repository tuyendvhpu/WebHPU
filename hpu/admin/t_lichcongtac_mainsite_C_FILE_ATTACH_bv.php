...
// Create page object
$t_lichcongtac_mainsite_C_FILE_ATTACH_blobview = new ct_lichcongtac_mainsite_C_FILE_ATTACH_blobview();
$Page =& $t_lichcongtac_mainsite_C_FILE_ATTACH_blobview;

// Page init
$t_lichcongtac_mainsite_C_FILE_ATTACH_blobview->Page_Init();

// Page main
$t_lichcongtac_mainsite_C_FILE_ATTACH_blobview->Page_Main();
?>
<?php
$t_lichcongtac_mainsite_C_FILE_ATTACH_blobview->Page_Terminate();
?>
<?php
...
// Page class
//
class ct_lichcongtac_mainsite_C_FILE_ATTACH_blobview {

	// Page ID
	var $PageID = 'blobview';

	// Page object name
	var $PageObjName = 't_lichcongtac_mainsite_C_FILE_ATTACH_blobview';
	...
	//
	function ct_lichcongtac_mainsite_C_FILE_ATTACH_blobview() {
	...
	function Page_Init() {
		...
		$Security->LoadCurrentUserLevel('t_lichcongtac_mainsite');
	...
	function Page_Main() {
		...
		$objBinary = new cUpload('t_lichcongtac_mainsite', 'x_C_FILE_ATTACH');
		...
		if ($rs = $conn->Execute($sSql)) {
			if (!$rs->EOF) {
				...
				if (trim(strval($rs->fields('C_FILE_ATTACH'))) <> "") {
					header("Content-Disposition: attachment; filename=" . $rs->fields('C_FILE_ATTACH'));
				}
				$objBinary->Value = $rs->fields('C_FILE_ATTACH');
