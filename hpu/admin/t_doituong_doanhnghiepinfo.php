...
$t_doituong_doanhnghiep = NULL;

//
// Table class for t_doituong_doanhnghiep
//
class ct_doituong_doanhnghiep {
	var $TableVar = 't_doituong_doanhnghiep';
	var $TableName = 't_doituong_doanhnghiep';
	var $TableType = 'TABLE';
	var $DTDOANHNGHIEP_ID;
	var $C_NAME;
	var $C_BELONGTO;
	var $C_TYPE;
	var $C_URL;
	...
	//
	function ct_doituong_doanhnghiep() {
		global $Language;

		// DTDOANHNGHIEP_ID
		$this->DTDOANHNGHIEP_ID = new cField('t_doituong_doanhnghiep', 't_doituong_doanhnghiep', 'x_DTDOANHNGHIEP_ID', 'DTDOANHNGHIEP_ID', '`DTDOANHNGHIEP_ID`', 3, -1, FALSE, '`DTDOANHNGHIEP_ID`', FALSE);
		$this->DTDOANHNGHIEP_ID->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['DTDOANHNGHIEP_ID'] =& $this->DTDOANHNGHIEP_ID;

		// C_NAME
		$this->C_NAME = new cField('t_doituong_doanhnghiep', 't_doituong_doanhnghiep', 'x_C_NAME', 'C_NAME', '`C_NAME`', 200, -1, FALSE, '`C_NAME`', FALSE);
		$this->fields['C_NAME'] =& $this->C_NAME;

		// C_BELONGTO
		$this->C_BELONGTO = new cField('t_doituong_doanhnghiep', 't_doituong_doanhnghiep', 'x_C_BELONGTO', 'C_BELONGTO', '`C_BELONGTO`', 3, -1, FALSE, '`C_BELONGTO`', FALSE);
		$this->C_BELONGTO->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['C_BELONGTO'] =& $this->C_BELONGTO;

		// C_TYPE
		$this->C_TYPE = new cField('t_doituong_doanhnghiep', 't_doituong_doanhnghiep', 'x_C_TYPE', 'C_TYPE', '`C_TYPE`', 3, -1, FALSE, '`C_TYPE`', FALSE);
		$this->C_TYPE->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['C_TYPE'] =& $this->C_TYPE;

		// C_URL
		$this->C_URL = new cField('t_doituong_doanhnghiep', 't_doituong_doanhnghiep', 'x_C_URL', 'C_URL', '`C_URL`', 200, -1, FALSE, '`C_URL`', FALSE);
		$this->fields['C_URL'] =& $this->C_URL;

		// C_ORDER
		$this->C_ORDER = new cField('t_doituong_doanhnghiep', 't_doituong_doanhnghiep', 'x_C_ORDER', 'C_ORDER', '`C_ORDER`', 3, -1, FALSE, '`C_ORDER`', FALSE);
		$this->C_ORDER->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['C_ORDER'] =& $this->C_ORDER;

		// C_ACTIVE
		$this->C_ACTIVE = new cField('t_doituong_doanhnghiep', 't_doituong_doanhnghiep', 'x_C_ACTIVE', 'C_ACTIVE', '`C_ACTIVE`', 3, -1, FALSE, '`C_ACTIVE`', FALSE);
		$this->C_ACTIVE->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['C_ACTIVE'] =& $this->C_ACTIVE;

		// C_USER_ADD
		$this->C_USER_ADD = new cField('t_doituong_doanhnghiep', 't_doituong_doanhnghiep', 'x_C_USER_ADD', 'C_USER_ADD', '`C_USER_ADD`', 3, -1, FALSE, '`C_USER_ADD`', FALSE);
		$this->C_USER_ADD->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['C_USER_ADD'] =& $this->C_USER_ADD;

		// C_ADD_TIME
		$this->C_ADD_TIME = new cField('t_doituong_doanhnghiep', 't_doituong_doanhnghiep', 'x_C_ADD_TIME', 'C_ADD_TIME', '`C_ADD_TIME`', 135, 7, FALSE, '`C_ADD_TIME`', FALSE);
		$this->C_ADD_TIME->FldDefaultErrMsg = str_replace("%s", "/", $Language->Phrase("IncorrectDateDMY"));
		$this->fields['C_ADD_TIME'] =& $this->C_ADD_TIME;

		// C_USER_EDIT
		$this->C_USER_EDIT = new cField('t_doituong_doanhnghiep', 't_doituong_doanhnghiep', 'x_C_USER_EDIT', 'C_USER_EDIT', '`C_USER_EDIT`', 3, -1, FALSE, '`C_USER_EDIT`', FALSE);
		$this->C_USER_EDIT->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['C_USER_EDIT'] =& $this->C_USER_EDIT;

		// C_EDIT_TIME
		$this->C_EDIT_TIME = new cField('t_doituong_doanhnghiep', 't_doituong_doanhnghiep', 'x_C_EDIT_TIME', 'C_EDIT_TIME', '`C_EDIT_TIME`', 135, 7, FALSE, '`C_EDIT_TIME`', FALSE);
		$this->C_EDIT_TIME->FldDefaultErrMsg = str_replace("%s", "/", $Language->Phrase("IncorrectDateDMY"));
		$this->fields['C_EDIT_TIME'] =& $this->C_EDIT_TIME;

		// C_FK_CONGTY
		$this->C_FK_CONGTY = new cField('t_doituong_doanhnghiep', 't_doituong_doanhnghiep', 'x_C_FK_CONGTY', 'C_FK_CONGTY', '`C_FK_CONGTY`', 3, -1, FALSE, '`C_FK_CONGTY`', FALSE);
		$this->C_FK_CONGTY->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['C_FK_CONGTY'] =& $this->C_FK_CONGTY;
	}
	...
	function HighlightName() {
		return "t_doituong_doanhnghiep_Highlight";
	}
	...
	function SqlWhere() { // Where
		$sWhere = "";
                if (!isset($_SESSION['DN_BELONGTO_ID']) || $_SESSION['DN_BELONGTO_ID'] =='')
                            {  $sWhere = "`t_doituong_doanhnghiep`.`C_BELONGTO` = 0";  }
                             else { $sWhere = "`t_doituong_doanhnghiep`.`C_BELONGTO` = ".@$_SESSION['DN_BELONGTO_ID']; }
		$this->TableFilter = "";
		if ($this->TableFilter <> "") {
	...
	function InsertSQL(&$rs) {
		...
		return "INSERT INTO `t_doituong_doanhnghiep` ($names) VALUES ($values)";
	}

	// UPDATE statement
	function UpdateSQL(&$rs) {
		global $conn;
		$SQL = "UPDATE `t_doituong_doanhnghiep` SET ";
		foreach ($rs as $name => $value) {
	...
	function DeleteSQL(&$rs) {
		$SQL = "DELETE FROM `t_doituong_doanhnghiep` WHERE ";
		$SQL .= ew_QuotedName('DTDOANHNGHIEP_ID') . '=' . ew_QuotedValue($rs['DTDOANHNGHIEP_ID'], $this->DTDOANHNGHIEP_ID->FldDataType) . ' AND ';
	...
	function SqlKeyFilter() {
		return "`DTDOANHNGHIEP_ID` = @DTDOANHNGHIEP_ID@";
	}

	// Key filter
	function KeyFilter() {
		$sKeyFilter = $this->SqlKeyFilter();
		if (!is_numeric($this->DTDOANHNGHIEP_ID->CurrentValue))
			$sKeyFilter = "0=1"; // Invalid key
		$sKeyFilter = str_replace("@DTDOANHNGHIEP_ID@", ew_AdjustSql($this->DTDOANHNGHIEP_ID->CurrentValue), $sKeyFilter); // Replace key value
		return $sKeyFilter;
	}
	...
	function getReturnUrl() {
		...
		if (@$_SESSION[$name] <> "") {
			...
			return "t_doituong_doanhnghieplist.php";
		}
	}
	...
	// View URL
	function ViewUrl() {
		return $this->KeyUrl("t_doituong_doanhnghiepview.php", $this->UrlParm());
	}

	// Add URL
	function AddUrl() {
		$AddUrl = "t_doituong_doanhnghiepadd.php";
	...
	// Edit URL
	function EditUrl() {
		return $this->KeyUrl("t_doituong_doanhnghiepedit.php", $this->UrlParm());
	}
	...
	// Copy URL
	function CopyUrl() {
		return $this->KeyUrl("t_doituong_doanhnghiepadd.php", $this->UrlParm());
	}
	...
	// Delete URL
	function DeleteUrl() {
		return $this->KeyUrl("t_doituong_doanhnghiepdelete.php", $this->UrlParm());
	}
	...
	function KeyUrl($url, $parm = "") {
		$sUrl = $url . "?";
		if ($parm <> "") $sUrl .= $parm . "&";
		if (!is_null($this->DTDOANHNGHIEP_ID->CurrentValue)) {
			$sUrl .= "DTDOANHNGHIEP_ID=" . urlencode($this->DTDOANHNGHIEP_ID->CurrentValue);
		} else {
	...
	function UrlParm($parm = "") {
		$UrlParm = ($this->UseTokenInUrl) ? "t=t_doituong_doanhnghiep" : "";
		if ($parm <> "") {
			if ($UrlParm <> "")
				$UrlParm .= "&";
			$UrlParm .= $parm;
	...
	function LoadListRowValues(&$rs) {
		$this->DTDOANHNGHIEP_ID->setDbValue($rs->fields('DTDOANHNGHIEP_ID'));
		...
		$this->C_FK_CONGTY->setDbValue($rs->fields('C_FK_CONGTY'));
	}
   ...
   // Common render codes
		...
		if (strval($this->C_BELONGTO->CurrentValue) <> "") {
			$sFilterWrk = "`DTDOANHNGHIEP_ID` = " . ew_AdjustSql($this->C_BELONGTO->CurrentValue) . "";
		...
		if ($sWhereWrk <> "") $sSqlWrk .= " WHERE " . $sWhereWrk;
			...
			if ($rswrk && !$rswrk->EOF) { // Lookup values found
				$this->C_BELONGTO->ViewValue = $rswrk->fields('C_NAME');
				$rswrk->Close();
			} else {
				$this->C_BELONGTO->ViewValue = $this->C_BELONGTO->CurrentValue;
			}
		} else {
			$this->C_BELONGTO->ViewValue = NULL;
		}
		...
		if (strval($this->C_TYPE->CurrentValue) <> "") {
			switch ($this->C_TYPE->CurrentValue) {
				case "0":
					$this->C_TYPE->ViewValue = "danh muc 1 bai viet";
					break;
				case "1":
					$this->C_TYPE->ViewValue = "danh muc list he thong ";
					break;
				case "2":
