...
// Create page object
$t_htlienquan_C_ICON_blobview = new ct_htlienquan_C_ICON_blobview();
$Page =& $t_htlienquan_C_ICON_blobview;

// Page init
$t_htlienquan_C_ICON_blobview->Page_Init();

// Page main
$t_htlienquan_C_ICON_blobview->Page_Main();
?>
<?php
$t_htlienquan_C_ICON_blobview->Page_Terminate();
?>
<?php
...
// Page class
//
class ct_htlienquan_C_ICON_blobview {

	// Page ID
	var $PageID = 'blobview';

	// Page object name
	var $PageObjName = 't_htlienquan_C_ICON_blobview';
	...
	//
	function ct_htlienquan_C_ICON_blobview() {
	...
	function Page_Init() {
		...
		$Security->LoadCurrentUserLevel('t_htlienquan');
	...
	function Page_Main() {
		...
		$objBinary = new cUpload('t_htlienquan', 'x_C_ICON');
