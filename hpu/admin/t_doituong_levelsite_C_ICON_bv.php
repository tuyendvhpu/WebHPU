...
// Create page object
$t_doituong_levelsite_C_ICON_blobview = new ct_doituong_levelsite_C_ICON_blobview();
$Page =& $t_doituong_levelsite_C_ICON_blobview;

// Page init
$t_doituong_levelsite_C_ICON_blobview->Page_Init();

// Page main
$t_doituong_levelsite_C_ICON_blobview->Page_Main();
?>
<?php
$t_doituong_levelsite_C_ICON_blobview->Page_Terminate();
?>
<?php
...
// Page class
//
class ct_doituong_levelsite_C_ICON_blobview {

	// Page ID
	var $PageID = 'blobview';

	// Page object name
	var $PageObjName = 't_doituong_levelsite_C_ICON_blobview';
	...
	//
	function ct_doituong_levelsite_C_ICON_blobview() {
	...
	function Page_Init() {
		...
		$Security->LoadCurrentUserLevel('t_doituong_levelsite');
	...
	function Page_Main() {
		...
		$objBinary = new cUpload('t_doituong_levelsite', 'x_C_ICON');
		...
		if ($rs = $conn->Execute($sSql)) {
			if (!$rs->EOF) {
				...
				$objBinary->Value = $rs->fields('C_ICON');
