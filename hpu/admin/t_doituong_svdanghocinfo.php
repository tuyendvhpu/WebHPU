...
$t_doituong_svdanghoc = NULL;

//
// Table class for t_doituong_svdanghoc
//
class ct_doituong_svdanghoc {
	var $TableVar = 't_doituong_svdanghoc';
	...
	//
	function ct_doituong_svdanghoc() {
		global $Language;

		// DTSVDANGHOC_ID
		$this->DTSVDANGHOC_ID = new cField('t_doituong_svdanghoc', 't_doituong_svdanghoc', 'x_DTSVDANGHOC_ID', 'DTSVDANGHOC_ID', '`DTSVDANGHOC_ID`', 3, -1, FALSE, '`DTSVDANGHOC_ID`', FALSE);
		$this->DTSVDANGHOC_ID->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['DTSVDANGHOC_ID'] =& $this->DTSVDANGHOC_ID;

		// C_NAME
		$this->C_NAME = new cField('t_doituong_svdanghoc', 't_doituong_svdanghoc', 'x_C_NAME', 'C_NAME', '`C_NAME`', 200, -1, FALSE, '`C_NAME`', FALSE);
		$this->fields['C_NAME'] =& $this->C_NAME;

		// C_BELONGTO
		$this->C_BELONGTO = new cField('t_doituong_svdanghoc', 't_doituong_svdanghoc', 'x_C_BELONGTO', 'C_BELONGTO', '`C_BELONGTO`', 3, -1, FALSE, '`C_BELONGTO`', FALSE);
		$this->C_BELONGTO->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['C_BELONGTO'] =& $this->C_BELONGTO;

		// C_TYPE
		$this->C_TYPE = new cField('t_doituong_svdanghoc', 't_doituong_svdanghoc', 'x_C_TYPE', 'C_TYPE', '`C_TYPE`', 3, -1, FALSE, '`C_TYPE`', FALSE);
		$this->C_TYPE->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['C_TYPE'] =& $this->C_TYPE;

		// C_URL
		$this->C_URL = new cField('t_doituong_svdanghoc', 't_doituong_svdanghoc', 'x_C_URL', 'C_URL', '`C_URL`', 200, -1, FALSE, '`C_URL`', FALSE);
		$this->fields['C_URL'] =& $this->C_URL;

		// C_ACTIVE
		$this->C_ACTIVE = new cField('t_doituong_svdanghoc', 't_doituong_svdanghoc', 'x_C_ACTIVE', 'C_ACTIVE', '`C_ACTIVE`', 3, -1, FALSE, '`C_ACTIVE`', FALSE);
		$this->C_ACTIVE->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['C_ACTIVE'] =& $this->C_ACTIVE;

		// C_USER_ADD
		$this->C_USER_ADD = new cField('t_doituong_svdanghoc', 't_doituong_svdanghoc', 'x_C_USER_ADD', 'C_USER_ADD', '`C_USER_ADD`', 3, -1, FALSE, '`C_USER_ADD`', FALSE);
		$this->C_USER_ADD->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['C_USER_ADD'] =& $this->C_USER_ADD;

		// C_TIME_ADD
		$this->C_TIME_ADD = new cField('t_doituong_svdanghoc', 't_doituong_svdanghoc', 'x_C_TIME_ADD', 'C_TIME_ADD', '`C_TIME_ADD`', 135, 7, FALSE, '`C_TIME_ADD`', FALSE);
		$this->C_TIME_ADD->FldDefaultErrMsg = str_replace("%s", "/", $Language->Phrase("IncorrectDateDMY"));
		$this->fields['C_TIME_ADD'] =& $this->C_TIME_ADD;

		// C_USER_EDIT
		$this->C_USER_EDIT = new cField('t_doituong_svdanghoc', 't_doituong_svdanghoc', 'x_C_USER_EDIT', 'C_USER_EDIT', '`C_USER_EDIT`', 3, -1, FALSE, '`C_USER_EDIT`', FALSE);
		$this->C_USER_EDIT->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['C_USER_EDIT'] =& $this->C_USER_EDIT;

		// C_TIME_EDIT
		$this->C_TIME_EDIT = new cField('t_doituong_svdanghoc', 't_doituong_svdanghoc', 'x_C_TIME_EDIT', 'C_TIME_EDIT', '`C_TIME_EDIT`', 135, 7, FALSE, '`C_TIME_EDIT`', FALSE);
		$this->C_TIME_EDIT->FldDefaultErrMsg = str_replace("%s", "/", $Language->Phrase("IncorrectDateDMY"));
		$this->fields['C_TIME_EDIT'] =& $this->C_TIME_EDIT;

		// FK_CONGTY
		$this->FK_CONGTY = new cField('t_doituong_svdanghoc', 't_doituong_svdanghoc', 'x_FK_CONGTY', 'FK_CONGTY', '`FK_CONGTY`', 3, -1, FALSE, '`FK_CONGTY`', FALSE);
	...
	function HighlightName() {
		return "t_doituong_svdanghoc_Highlight";
	}
	...
	function SqlWhere() { // Where
		$sWhere = "";
                   global $Security;
                            ...
                            {  $sWhere = "`t_doituong_svdanghoc`.`C_BELONGTO` = 0";  }
                             else { $sWhere = "`t_doituong_svdanghoc`.`C_BELONGTO` = ".@$_SESSION['C_BELONGTO_ID']; }
	...
	function InsertSQL(&$rs) {
		...
		return "INSERT INTO `t_doituong_svdanghoc` ($names) VALUES ($values)";
	}

	// UPDATE statement
	function UpdateSQL(&$rs) {
		global $conn;
		$SQL = "UPDATE `t_doituong_svdanghoc` SET ";
		foreach ($rs as $name => $value) {
	...
	function DeleteSQL(&$rs) {
		$SQL = "DELETE FROM `t_doituong_svdanghoc` WHERE ";
		$SQL .= ew_QuotedName('DTSVDANGHOC_ID') . '=' . ew_QuotedValue($rs['DTSVDANGHOC_ID'], $this->DTSVDANGHOC_ID->FldDataType) . ' AND ';
	...
	function SqlKeyFilter() {
		return "`DTSVDANGHOC_ID` = @DTSVDANGHOC_ID@";
	}

	// Key filter
	function KeyFilter() {
		$sKeyFilter = $this->SqlKeyFilter();
		if (!is_numeric($this->DTSVDANGHOC_ID->CurrentValue))
			$sKeyFilter = "0=1"; // Invalid key
		$sKeyFilter = str_replace("@DTSVDANGHOC_ID@", ew_AdjustSql($this->DTSVDANGHOC_ID->CurrentValue), $sKeyFilter); // Replace key value
		return $sKeyFilter;
	}
	...
	function getReturnUrl() {
		...
		if (@$_SESSION[$name] <> "") {
			...
			return "t_doituong_svdanghoclist.php";
		}
	}
	...
	// View URL
	function ViewUrl() {
		return $this->KeyUrl("t_doituong_svdanghocview.php", $this->UrlParm());
	}

	// Add URL
	function AddUrl() {
		$AddUrl = "t_doituong_svdanghocadd.php";
	...
	// Edit URL
	function EditUrl() {
		return $this->KeyUrl("t_doituong_svdanghocedit.php", $this->UrlParm());
	}
	...
	// Copy URL
	function CopyUrl() {
		return $this->KeyUrl("t_doituong_svdanghocadd.php", $this->UrlParm());
	}
	...
	// Delete URL
	function DeleteUrl() {
		return $this->KeyUrl("t_doituong_svdanghocdelete.php", $this->UrlParm());
	}
	...
	function KeyUrl($url, $parm = "") {
		$sUrl = $url . "?";
		if ($parm <> "") $sUrl .= $parm . "&";
		if (!is_null($this->DTSVDANGHOC_ID->CurrentValue)) {
			$sUrl .= "DTSVDANGHOC_ID=" . urlencode($this->DTSVDANGHOC_ID->CurrentValue);
		} else {
	...
	function UrlParm($parm = "") {
		$UrlParm = ($this->UseTokenInUrl) ? "t=t_doituong_svdanghoc" : "";
		if ($parm <> "") {
			if ($UrlParm <> "")
				$UrlParm .= "&";
			$UrlParm .= $parm;
	...
	function LoadListRowValues(&$rs) {
		$this->DTSVDANGHOC_ID->setDbValue($rs->fields('DTSVDANGHOC_ID'));
		...
		if (strval($this->C_TYPE->CurrentValue) <> "") {
			switch ($this->C_TYPE->CurrentValue) {
				case "0":
					...
					break;
				case "1":
					$this->C_TYPE->ViewValue = "Danh muc list bai viet";
					break;
				case "2":
					$this->C_TYPE->ViewValue = "Danh muc url lienket";
					break;
				default:
