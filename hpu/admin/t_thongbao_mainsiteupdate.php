...
<?php if ($t_thongbao_mainsite->C_TITLE->Visible) { // C_TITLE ?>
	<tr<?php echo $t_thongbao_mainsite->C_TITLE->RowAttributes ?>>
		...
		<td<?php echo $t_thongbao_mainsite->C_TITLE->CellAttributes() ?>><span id="el_C_TITLE">
                        <input readonly="true" type="text" name="x_C_TITLE" id="x_C_TITLE" title="<?php echo $t_thongbao_mainsite->C_TITLE->FldTitle() ?>" size="80" maxlength="255" value="<?php echo $t_thongbao_mainsite->C_TITLE->EditValue ?>"<?php echo $t_thongbao_mainsite->C_TITLE->EditAttributes() ?>>
		...
		if ($rs->EOF) {
			...
			// C_PUBLISH
                        $t_thongbao_mainsite->C_PUBLISH->SetDbValueDef($rsnew, $t_thongbao_mainsite->C_PUBLISH->CurrentValue, NULL, FALSE);
                         if ($t_thongbao_mainsite->C_PUBLISH->CurrentValue == "1") {
                             // FK_NGUOIDUNG_ID
