...
// Create page object
$t_congty_C_LOGO_blobview = new ct_congty_C_LOGO_blobview();
$Page =& $t_congty_C_LOGO_blobview;

// Page init
$t_congty_C_LOGO_blobview->Page_Init();

// Page main
$t_congty_C_LOGO_blobview->Page_Main();
?>
<?php
$t_congty_C_LOGO_blobview->Page_Terminate();
?>
<?php
...
// Page class
//
class ct_congty_C_LOGO_blobview {

	// Page ID
	var $PageID = 'blobview';

	// Page object name
	var $PageObjName = 't_congty_C_LOGO_blobview';
	...
	//
	function ct_congty_C_LOGO_blobview() {
	...
	function Page_Init() {
		...
		$Security->LoadCurrentUserLevel('t_congty');
	...
	function Page_Main() {
		...
		$objBinary = new cUpload('t_congty', 'x_C_LOGO');
		...
		if ($rs = $conn->Execute($sSql)) {
			if (!$rs->EOF) {
				...
				$objBinary->Value = $rs->fields('C_LOGO');
