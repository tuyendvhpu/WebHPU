...
// Create page object
$t_doituong_doanhnghiep_add = new ct_doituong_doanhnghiep_add();
$Page =& $t_doituong_doanhnghiep_add;

// Page init
$t_doituong_doanhnghiep_add->Page_Init();

// Page main
$t_doituong_doanhnghiep_add->Page_Main();
?>
...
// Create page object
var t_doituong_doanhnghiep_add = new ew_Page("t_doituong_doanhnghiep_add");

// page properties
t_doituong_doanhnghiep_add.PageID = "add"; // page ID
t_doituong_doanhnghiep_add.FormID = "ft_doituong_doanhnghiepadd"; // form ID
var EW_PAGE_ID = t_doituong_doanhnghiep_add.PageID; // for backward compatibility

// extend page with ValidateForm function
t_doituong_doanhnghiep_add.ValidateForm = function(fobj) {
...
t_doituong_doanhnghiep_add.Form_CustomValidate =  
 function(fobj) { // DO NOT CHANGE THIS LINE!

 	// Your custom validation code here, return false if invalid. 
 	return true;
 }
t_doituong_doanhnghiep_add.SelectAllKey = function(elem) {
	ew_SelectAll(elem);
	ew_ClickAll(elem);
}
<?php if (EW_CLIENT_VALIDATE) { ?>
t_doituong_doanhnghiep_add.ValidateRequired = true; // uses JavaScript validation
<?php } else { ?>
t_doituong_doanhnghiep_add.ValidateRequired = false; // no JavaScript validation
<?php } ?>
...
<p class="pheader"><?php echo $t_doituong_doanhnghiep->TableCaption() ?></p>
<a href="<?php echo $t_doituong_doanhnghiep->getReturnUrl() ?>"><?php echo $Language->Phrase("GoBack") ?></a>
<?php
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
$t_doituong_doanhnghiep_add->ShowMessage();
?>
<form name="ft_doituong_doanhnghiepadd" id="ft_doituong_doanhnghiepadd" action="<?php echo ew_CurrentPage() ?>" method="post" onsubmit="return t_doituong_doanhnghiep_add.ValidateForm(this);">
<p>
...
<input type="text" name="x_C_NAME" id="x_C_NAME" title="<?php echo $t_doituong_doanhnghiep->C_NAME->FldTitle() ?>" size="80" maxlength="255" value="<?php echo $t_doituong_doanhnghiep->C_NAME->EditValue ?>"<?php echo $t_doituong_doanhnghiep->C_NAME->EditAttributes() ?>>
...
<input type="text" name="x_C_URL" id="x_C_URL" title="<?php echo $t_doituong_doanhnghiep->C_URL->FldTitle() ?>" size="80" maxlength="255" value="<?php echo $t_doituong_doanhnghiep->C_URL->EditValue ?>"<?php echo $t_doituong_doanhnghiep->C_URL->EditAttributes() ?>>
...
<input type="text" name="x_C_ORDER" id="x_C_ORDER" title="<?php echo $t_doituong_doanhnghiep->C_ORDER->FldTitle() ?>" size="10" value="<?php echo $t_doituong_doanhnghiep->C_ORDER->EditValue ?>"<?php echo $t_doituong_doanhnghiep->C_ORDER->EditAttributes() ?>>
...
<?php
$t_doituong_doanhnghiep_add->Page_Terminate();
?>
<?php
...
// Page class
//
class ct_doituong_doanhnghiep_add {
	...
	// Page object name
	var $PageObjName = 't_doituong_doanhnghiep_add';
	...
	//
	function ct_doituong_doanhnghiep_add() {
	...
	function Page_Main() {
		...
		if (@$_POST["a_add"] <> "") {
		   $t_doituong_doanhnghiep->CurrentAction = $_POST["a_add"]; // Get form action
		  $this->LoadFormValues(); // Load form values

			// Validate form
			if (!$this->ValidateForm()) {
				$t_doituong_doanhnghiep->CurrentAction = "I"; // Form error, reset action
				$this->setMessage($gsFormError);
			}
		} else { // Not post back
		  if ($bCopy) {
		    $t_doituong_doanhnghiep->CurrentAction = "C"; // Copy record
		  } else {
		    $t_doituong_doanhnghiep->CurrentAction = "I"; // Display blank record
		...
		switch ($t_doituong_doanhnghiep->CurrentAction) {
		  ...
		  case "A": // ' Add new record
				$t_doituong_doanhnghiep->SendEmail = TRUE; // Send email on add success
		    if ($this->AddRow()) { // Add successful
		      $this->setMessage($Language->Phrase("AddSuccess")); // Set up success message
					...
					if (ew_GetPageName($sReturnUrl) == "t_doituong_doanhnghiepview.php")
						$sReturnUrl = $t_doituong_doanhnghiep->ViewUrl(); // View paging, return to view page with keyurl directly
		...
		$t_doituong_doanhnghiep->RowType = EW_ROWTYPE_ADD;  // Render add type
	...
	function LoadFormValues() {
		...
		$t_doituong_doanhnghiep->C_USER_ADD->setFormValue($objForm->GetValue("x_C_USER_ADD"));
		$t_doituong_doanhnghiep->C_ADD_TIME->setFormValue($objForm->GetValue("x_C_ADD_TIME"));
		$t_doituong_doanhnghiep->C_ADD_TIME->CurrentValue = ew_UnFormatDateTime($t_doituong_doanhnghiep->C_ADD_TIME->CurrentValue, 7);
	...
	function RestoreFormValues() {
		...
		$t_doituong_doanhnghiep->C_USER_ADD->CurrentValue = $t_doituong_doanhnghiep->C_USER_ADD->FormValue;
		$t_doituong_doanhnghiep->C_ADD_TIME->CurrentValue = $t_doituong_doanhnghiep->C_ADD_TIME->FormValue;
		$t_doituong_doanhnghiep->C_ADD_TIME->CurrentValue = ew_UnFormatDateTime($t_doituong_doanhnghiep->C_ADD_TIME->CurrentValue, 7);
	}
	...
	function RenderRow() {
		...
		} elseif ($t_doituong_doanhnghiep->RowType == EW_ROWTYPE_ADD) { // Add row
	...
	function AddRow() {
		...
		// C_BELONGTO
		//$t_doituong_doanhnghiep->C_BELONGTO->SetDbValueDef($rsnew, $t_doituong_doanhnghiep->C_BELONGTO->CurrentValue, NULL, FALSE);
                // * BY QUANG HUNG
                if (($_SESSION['DN_BELONGTO_ID'] == "") || (is_null($_SESSION['DN_BELONGTO_ID'])))
                    {
                    $t_doituong_doanhnghiep->C_BELONGTO->SetDbValueDef($rsnew, 0, 0, FALSE);
                    }
                    ELSE
                    {
                    $t_doituong_doanhnghiep->C_BELONGTO->SetDbValueDef($rsnew,$_SESSION['DN_BELONGTO_ID'],$_SESSION['DN_BELONGTO_ID'] );
                    }  
               
		// C_TYPE
		$t_doituong_doanhnghiep->C_TYPE->SetDbValueDef($rsnew, $t_doituong_doanhnghiep->C_TYPE->CurrentValue, NULL, FALSE);

		if ($t_doituong_doanhnghiep->C_TYPE->CurrentValue == '2' )
                 {    
		// C_URL
		$t_doituong_doanhnghiep->C_URL->SetDbValueDef($rsnew, $t_doituong_doanhnghiep->C_URL->CurrentValue, NULL, FALSE);
                 }
                 else {$t_doituong_doanhnghiep->C_URL->SetDbValueDef($rsnew, NULL, NULL, FALSE);} 
		...
		// C_USER_ADD
		$t_doituong_doanhnghiep->C_USER_ADD->SetDbValueDef($rsnew, CurrentUserID(), NULL);
		$rsnew['C_USER_ADD'] =& $t_doituong_doanhnghiep->C_USER_ADD->DbValue;

		// C_ADD_TIME
		$t_doituong_doanhnghiep->C_ADD_TIME->SetDbValueDef($rsnew, ew_CurrentDateTime(), NULL);
		$rsnew['C_ADD_TIME'] =& $t_doituong_doanhnghiep->C_ADD_TIME->DbValue;

		// Call Row Inserting event
		$bInsertRow = $t_doituong_doanhnghiep->Row_Inserting($rsnew);
		if ($bInsertRow) {
			$conn->raiseErrorFn = 'ew_ErrorFn';
			$AddRow = $conn->Execute($t_doituong_doanhnghiep->InsertSQL($rsnew));
			$conn->raiseErrorFn = '';
		} else {
		...
		if ($AddRow) {
			$t_doituong_doanhnghiep->DTDOANHNGHIEP_ID->setDbValue($conn->Insert_ID());
			$rsnew['DTDOANHNGHIEP_ID'] = $t_doituong_doanhnghiep->DTDOANHNGHIEP_ID->DbValue;

			// Call Row Inserted event
			$t_doituong_doanhnghiep->Row_Inserted($rsnew);
		}
		return $AddRow;
	}
