...
$t_lichcongtac_mainsite = NULL;

//
// Table class for t_lichcongtac_mainsite
//
class ct_lichcongtac_mainsite {
	var $TableVar = 't_lichcongtac_mainsite';
	...
	//
	function ct_lichcongtac_mainsite() {
		global $Language;

		// C_CADENLAR_ID
		$this->C_CADENLAR_ID = new cField('t_lichcongtac_mainsite', 't_lichcongtac_mainsite', 'x_C_CADENLAR_ID', 'C_CADENLAR_ID', '`C_CADENLAR_ID`', 3, -1, FALSE, '`C_CADENLAR_ID`', FALSE);
		$this->C_CADENLAR_ID->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['C_CADENLAR_ID'] =& $this->C_CADENLAR_ID;

		// FK_CONGTY
		$this->FK_CONGTY = new cField('t_lichcongtac_mainsite', 't_lichcongtac_mainsite', 'x_FK_CONGTY', 'FK_CONGTY', '`FK_CONGTY`', 3, -1, FALSE, '`FK_CONGTY`', FALSE);
		$this->FK_CONGTY->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['FK_CONGTY'] =& $this->FK_CONGTY;

		// FK_SB_ID
		$this->FK_SB_ID = new cField('t_lichcongtac_mainsite', 't_lichcongtac_mainsite', 'x_FK_SB_ID', 'FK_SB_ID', '`FK_SB_ID`', 3, -1, FALSE, '`FK_SB_ID`', FALSE);
		$this->FK_SB_ID->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['FK_SB_ID'] =& $this->FK_SB_ID;

		// C_TITLE
		$this->C_TITLE = new cField('t_lichcongtac_mainsite', 't_lichcongtac_mainsite', 'x_C_TITLE', 'C_TITLE', '`C_TITLE`', 200, -1, FALSE, '`C_TITLE`', FALSE);
		$this->fields['C_TITLE'] =& $this->C_TITLE;

		// C_DATE_STAR
		$this->C_DATE_STAR = new cField('t_lichcongtac_mainsite', 't_lichcongtac_mainsite', 'x_C_DATE_STAR', 'C_DATE_STAR', '`C_DATE_STAR`', 135, 7, FALSE, '`C_DATE_STAR`', FALSE);
		$this->C_DATE_STAR->FldDefaultErrMsg = str_replace("%s", "/", $Language->Phrase("IncorrectDateDMY"));
		$this->fields['C_DATE_STAR'] =& $this->C_DATE_STAR;

		// C_HOUR_START
		$this->C_HOUR_START = new cField('t_lichcongtac_mainsite', 't_lichcongtac_mainsite', 'x_C_HOUR_START', 'C_HOUR_START', '`C_HOUR_START`', 3, -1, FALSE, '`C_HOUR_START`', FALSE);
		$this->C_HOUR_START->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['C_HOUR_START'] =& $this->C_HOUR_START;

		// C_MINUTES_STAR
		$this->C_MINUTES_STAR = new cField('t_lichcongtac_mainsite', 't_lichcongtac_mainsite', 'x_C_MINUTES_STAR', 'C_MINUTES_STAR', '`C_MINUTES_STAR`', 200, -1, FALSE, '`C_MINUTES_STAR`', FALSE);
		$this->fields['C_MINUTES_STAR'] =& $this->C_MINUTES_STAR;

		// C_STATUS_STAR
		$this->C_STATUS_STAR = new cField('t_lichcongtac_mainsite', 't_lichcongtac_mainsite', 'x_C_STATUS_STAR', 'C_STATUS_STAR', '`C_STATUS_STAR`', 3, -1, FALSE, '`C_STATUS_STAR`', FALSE);
		$this->C_STATUS_STAR->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['C_STATUS_STAR'] =& $this->C_STATUS_STAR;

		// C_DATE_END
		$this->C_DATE_END = new cField('t_lichcongtac_mainsite', 't_lichcongtac_mainsite', 'x_C_DATE_END', 'C_DATE_END', '`C_DATE_END`', 135, 7, FALSE, '`C_DATE_END`', FALSE);
		$this->C_DATE_END->FldDefaultErrMsg = str_replace("%s", "/", $Language->Phrase("IncorrectDateDMY"));
		$this->fields['C_DATE_END'] =& $this->C_DATE_END;

		// C_HOUR_END
		$this->C_HOUR_END = new cField('t_lichcongtac_mainsite', 't_lichcongtac_mainsite', 'x_C_HOUR_END', 'C_HOUR_END', '`C_HOUR_END`', 3, -1, FALSE, '`C_HOUR_END`', FALSE);
		$this->C_HOUR_END->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['C_HOUR_END'] =& $this->C_HOUR_END;

		// C_MINUTES_END
		$this->C_MINUTES_END = new cField('t_lichcongtac_mainsite', 't_lichcongtac_mainsite', 'x_C_MINUTES_END', 'C_MINUTES_END', '`C_MINUTES_END`', 200, -1, FALSE, '`C_MINUTES_END`', FALSE);
		$this->fields['C_MINUTES_END'] =& $this->C_MINUTES_END;

		// C_STATUS_END
		$this->C_STATUS_END = new cField('t_lichcongtac_mainsite', 't_lichcongtac_mainsite', 'x_C_STATUS_END', 'C_STATUS_END', '`C_STATUS_END`', 3, -1, FALSE, '`C_STATUS_END`', FALSE);
		$this->C_STATUS_END->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['C_STATUS_END'] =& $this->C_STATUS_END;

		// C_CONTENT
		$this->C_CONTENT = new cField('t_lichcongtac_mainsite', 't_lichcongtac_mainsite', 'x_C_CONTENT', 'C_CONTENT', '`C_CONTENT`', 201, -1, FALSE, '`C_CONTENT`', FALSE);
		$this->C_CONTENT->TruncateMemoRemoveHtml = TRUE;
		$this->fields['C_CONTENT'] =& $this->C_CONTENT;

		// C_ORGANIZATION
		$this->C_ORGANIZATION = new cField('t_lichcongtac_mainsite', 't_lichcongtac_mainsite', 'x_C_ORGANIZATION', 'C_ORGANIZATION', '`C_ORGANIZATION`', 200, -1, FALSE, '`C_ORGANIZATION`', FALSE);
		$this->fields['C_ORGANIZATION'] =& $this->C_ORGANIZATION;

		// C_PARTICIPANTS_ID
		$this->C_PARTICIPANTS_ID = new cField('t_lichcongtac_mainsite', 't_lichcongtac_mainsite', 'x_C_PARTICIPANTS_ID', 'C_PARTICIPANTS_ID', '`C_PARTICIPANTS_ID`', 200, -1, FALSE, '`C_PARTICIPANTS_ID`', FALSE);
		$this->fields['C_PARTICIPANTS_ID'] =& $this->C_PARTICIPANTS_ID;

		// C_WHERE
		$this->C_WHERE = new cField('t_lichcongtac_mainsite', 't_lichcongtac_mainsite', 'x_C_WHERE', 'C_WHERE', '`C_WHERE`', 200, -1, FALSE, '`C_WHERE`', FALSE);
		$this->fields['C_WHERE'] =& $this->C_WHERE;

		// C_PREPARED
		$this->C_PREPARED = new cField('t_lichcongtac_mainsite', 't_lichcongtac_mainsite', 'x_C_PREPARED', 'C_PREPARED', '`C_PREPARED`', 200, -1, FALSE, '`C_PREPARED`', FALSE);
		$this->fields['C_PREPARED'] =& $this->C_PREPARED;

		// C_OPTION
		$this->C_OPTION = new cField('t_lichcongtac_mainsite', 't_lichcongtac_mainsite', 'x_C_OPTION', 'C_OPTION', '`C_OPTION`', 3, -1, FALSE, '`C_OPTION`', FALSE);
		$this->C_OPTION->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['C_OPTION'] =& $this->C_OPTION;

		// C_FILE_ATTACH
		$this->C_FILE_ATTACH = new cField('t_lichcongtac_mainsite', 't_lichcongtac_mainsite', 'x_C_FILE_ATTACH', 'C_FILE_ATTACH', '`C_FILE_ATTACH`', 200, -1, TRUE, '`C_FILE_ATTACH`', FALSE);
		$this->C_FILE_ATTACH->UploadPath = "../upload/ATTACK_CALEDAR";
		$this->fields['C_FILE_ATTACH'] =& $this->C_FILE_ATTACH;

		// C_ACTIVE
		$this->C_ACTIVE = new cField('t_lichcongtac_mainsite', 't_lichcongtac_mainsite', 'x_C_ACTIVE', 'C_ACTIVE', '`C_ACTIVE`', 3, -1, FALSE, '`C_ACTIVE`', FALSE);
		$this->C_ACTIVE->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['C_ACTIVE'] =& $this->C_ACTIVE;

		// C_DATETIME_ACTIVE
		$this->C_DATETIME_ACTIVE = new cField('t_lichcongtac_mainsite', 't_lichcongtac_mainsite', 'x_C_DATETIME_ACTIVE', 'C_DATETIME_ACTIVE', '`C_DATETIME_ACTIVE`', 135, 7, FALSE, '`C_DATETIME_ACTIVE`', FALSE);
		...
		// C_PUBLISH
		$this->C_PUBLISH = new cField('t_lichcongtac_mainsite', 't_lichcongtac_mainsite', 'x_C_PUBLISH', 'C_PUBLISH', '`C_PUBLISH`', 3, -1, FALSE, '`C_PUBLISH`', FALSE);
		$this->C_PUBLISH->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['C_PUBLISH'] =& $this->C_PUBLISH;

		// C_DATETIME_PUBLISH
		$this->C_DATETIME_PUBLISH = new cField('t_lichcongtac_mainsite', 't_lichcongtac_mainsite', 'x_C_DATETIME_PUBLISH', 'C_DATETIME_PUBLISH', '`C_DATETIME_PUBLISH`', 135, 7, FALSE, '`C_DATETIME_PUBLISH`', FALSE);
		...
		// C_FK_PUBLISH
		$this->C_FK_PUBLISH = new cField('t_lichcongtac_mainsite', 't_lichcongtac_mainsite', 'x_C_FK_PUBLISH', 'C_FK_PUBLISH', '`C_FK_PUBLISH`', 3, -1, FALSE, '`C_FK_PUBLISH`', FALSE);
		$this->C_FK_PUBLISH->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['C_FK_PUBLISH'] =& $this->C_FK_PUBLISH;

		// C_USER_ADD
		$this->C_USER_ADD = new cField('t_lichcongtac_mainsite', 't_lichcongtac_mainsite', 'x_C_USER_ADD', 'C_USER_ADD', '`C_USER_ADD`', 3, -1, FALSE, '`C_USER_ADD`', FALSE);
		$this->C_USER_ADD->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['C_USER_ADD'] =& $this->C_USER_ADD;

		// C_ADD_TIME
		$this->C_ADD_TIME = new cField('t_lichcongtac_mainsite', 't_lichcongtac_mainsite', 'x_C_ADD_TIME', 'C_ADD_TIME', '`C_ADD_TIME`', 135, 7, FALSE, '`C_ADD_TIME`', FALSE);
		$this->C_ADD_TIME->FldDefaultErrMsg = str_replace("%s", "/", $Language->Phrase("IncorrectDateDMY"));
		$this->fields['C_ADD_TIME'] =& $this->C_ADD_TIME;

		// C_USER_EDIT
		$this->C_USER_EDIT = new cField('t_lichcongtac_mainsite', 't_lichcongtac_mainsite', 'x_C_USER_EDIT', 'C_USER_EDIT', '`C_USER_EDIT`', 3, -1, FALSE, '`C_USER_EDIT`', FALSE);
		$this->C_USER_EDIT->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['C_USER_EDIT'] =& $this->C_USER_EDIT;

		// C_EDIT_TIME
		$this->C_EDIT_TIME = new cField('t_lichcongtac_mainsite', 't_lichcongtac_mainsite', 'x_C_EDIT_TIME', 'C_EDIT_TIME', '`C_EDIT_TIME`', 135, 7, FALSE, '`C_EDIT_TIME`', FALSE);
	...
	function HighlightName() {
		return "t_lichcongtac_mainsite_Highlight";
	}
	...
	function SqlSelect() { // Select
		return "SELECT t_lichcongtac.* FROM " . $this->SqlFrom();
	}

	function SqlWhere() { // Where
		  global $Security;
	    if (IsAdmin()) $sWhere ="";
            else $sWhere = "t_lichcongtac.FK_CONGTY = ".$Security->CurrentUserOption()." OR C_FK_PUBLISH =1";
		$this->TableFilter = "";
		if ($this->TableFilter <> "") {
	...
	function getReturnUrl() {
		...
		if (@$_SESSION[$name] <> "") {
			...
			return "t_lichcongtac_mainsitelist.php";
		}
	}
	...
	// View URL
	function ViewUrl() {
		return $this->KeyUrl("t_lichcongtac_mainsiteview.php", $this->UrlParm());
	}

	// Add URL
	function AddUrl() {
		$AddUrl = "t_lichcongtac_mainsiteadd.php";
	...
	// Edit URL
	function EditUrl() {
		return $this->KeyUrl("t_lichcongtac_mainsiteedit.php", $this->UrlParm());
	}
	...
	// Copy URL
	function CopyUrl() {
		return $this->KeyUrl("t_lichcongtac_mainsiteadd.php", $this->UrlParm());
	}
	...
	// Delete URL
	function DeleteUrl() {
		return $this->KeyUrl("t_lichcongtac_mainsitedelete.php", $this->UrlParm());
	}
	...
	function UrlParm($parm = "") {
		$UrlParm = ($this->UseTokenInUrl) ? "t=t_lichcongtac_mainsite" : "";
		if ($parm <> "") {
			if ($UrlParm <> "")
				$UrlParm .= "&";
			$UrlParm .= $parm;
   ...
   // Common render codes
		...
		// C_FILE_ATTACH
		$this->C_FILE_ATTACH->CellCssStyle = ""; $this->C_FILE_ATTACH->CellCssClass = "";
		$this->C_FILE_ATTACH->CellAttrs = array(); $this->C_FILE_ATTACH->ViewAttrs = array(); $this->C_FILE_ATTACH->EditAttrs = array();
		...
		// C_FILE_ATTACH
		if (!ew_Empty($this->C_FILE_ATTACH->Upload->DbValue)) {
			$this->C_FILE_ATTACH->ViewValue = $this->C_FILE_ATTACH->Upload->DbValue;
		} else {
			$this->C_FILE_ATTACH->ViewValue = "";
		}
		$this->C_FILE_ATTACH->CssStyle = "";
		$this->C_FILE_ATTACH->CssClass = "";
		$this->C_FILE_ATTACH->ViewCustomAttributes = "";

		// C_ACTIVE
		if (strval($this->C_ACTIVE->CurrentValue) <> "") {
			switch ($this->C_ACTIVE->CurrentValue) {
				case "0":
					$this->C_ACTIVE->ViewValue = "Khong active levelsite";
					break;
				case "1":
					$this->C_ACTIVE->ViewValue = "Active levelsite";
					break;
				default:
		...
		// C_FILE_ATTACH
		if (!ew_Empty($this->C_FILE_ATTACH->Upload->DbValue)) {
			$this->C_FILE_ATTACH->HrefValue = ew_UploadPathEx(FALSE, $this->C_FILE_ATTACH->UploadPath) . ((!empty($this->C_FILE_ATTACH->ViewValue)) ? $this->C_FILE_ATTACH->ViewValue : $this->C_FILE_ATTACH->CurrentValue);
			if ($this->Export <> "") $t_lichcongtac_mainsite->C_FILE_ATTACH->HrefValue = ew_ConvertFullUrl($this->C_FILE_ATTACH->HrefValue);
		} else {
			$this->C_FILE_ATTACH->HrefValue = "";
		}
		$this->C_FILE_ATTACH->TooltipValue = "";
