...
define("EW_PROJECT_NAME", "hpu", TRUE); // Project name
define("EW_RANDOM_KEY", 'Tw5eR7tgZqb0tuJN', TRUE); // Random key for encryption
define("EW_PROJECT_STYLESHEET_FILENAME", "hpu.css", TRUE); // Project stylesheet file name
...
// Khong cho phep chen link youtobe
...
//Cho phepchen linh youtobe
$EW_XSS_ARRAY = array('javascript', 'vbscript', 'expression', '<applet', '<meta', '<xml', '<blink', '<link', '<style', '<script', '<object','<frame', '<frameset', '<ilayer', '<layer', '<bgsound', '<title', '<base',
...
define("EW_SESSION_USER_OPTION",EW_PROJECT_NAME . "_EW_SESSION_USER_OPTION", TRUE);
...
define("EW_SESSION_AR_SUB_USER_LEVEL_PRIV", EW_PROJECT_NAME . "_arSubUserLevelPriv", TRUE); // Sub User Level privilege array
...
$EW_LANGUAGE_FILE[] = array("en", "", "vietnamese.xml");
...
//$EW_USER_LEVEL_TABLE_VAR[] = 'usersadmin';
//$EW_USER_LEVEL_TABLE_NAME[] = 'userlevels';
//$EW_USER_LEVEL_TABLE_VAR[] = 'userlevels';
$EW_USER_LEVEL_TABLE_NAME[] = 'users';
$EW_USER_LEVEL_TABLE_VAR[] = 'users';
$EW_USER_LEVEL_TABLE_NAME[] = 'user';
$EW_USER_LEVEL_TABLE_VAR[] = 'user';
$EW_USER_LEVEL_TABLE_NAME[] = 't_nganhnghe';
$EW_USER_LEVEL_TABLE_VAR[] = 't_nganhnghe';
$EW_USER_LEVEL_TABLE_NAME[] = 't_congty';
$EW_USER_LEVEL_TABLE_VAR[] = 't_congty';
$EW_USER_LEVEL_TABLE_NAME[] = 't_danhmucgioithieu';
$EW_USER_LEVEL_TABLE_VAR[] = 't_danhmucgioithieu';
$EW_USER_LEVEL_TABLE_NAME[] = 't_danhmuctuyensinh';
$EW_USER_LEVEL_TABLE_VAR[] = 't_danhmuctuyensinh';
$EW_USER_LEVEL_TABLE_NAME[] = 't_doituong_cuusv';
$EW_USER_LEVEL_TABLE_VAR[] = 't_doituong_cuusv';
$EW_USER_LEVEL_TABLE_NAME[] = 't_doituong_doanhnghiep';
$EW_USER_LEVEL_TABLE_VAR[] = 't_doituong_doanhnghiep';
$EW_USER_LEVEL_TABLE_NAME[] = 't_doituong_svdanghoc';
$EW_USER_LEVEL_TABLE_VAR[] = 't_doituong_svdanghoc';
$EW_USER_LEVEL_TABLE_NAME[] = 't_doituong_svtuonglai';
$EW_USER_LEVEL_TABLE_VAR[] = 't_doituong_svtuonglai';
$EW_USER_LEVEL_TABLE_NAME[] = 't_htlienquan';
$EW_USER_LEVEL_TABLE_VAR[] = 't_htlienquan';
$EW_USER_LEVEL_TABLE_NAME[] = 't_chuyenmuc_levelsite';
$EW_USER_LEVEL_TABLE_VAR[] = 't_chuyenmuc_levelsite';
$EW_USER_LEVEL_TABLE_NAME[] = 't_doituong_levelsite';
$EW_USER_LEVEL_TABLE_VAR[] = 't_doituong_levelsite';
$EW_USER_LEVEL_TABLE_NAME[] = 't_tinbai_levelsite';
$EW_USER_LEVEL_TABLE_VAR[] = 't_tinbai_levelsite';
$EW_USER_LEVEL_TABLE_NAME[] = 't_tinbai_mainsite';
$EW_USER_LEVEL_TABLE_VAR[] = 't_tinbai_mainsite';
$EW_USER_LEVEL_TABLE_NAME[] = 't_tinbai_mainsite_level';
$EW_USER_LEVEL_TABLE_VAR[] = 't_tinbai_mainsite_level';
$EW_USER_LEVEL_TABLE_NAME[] = 't_thongbao_levelsite';
$EW_USER_LEVEL_TABLE_VAR[] = 't_thongbao_levelsite';
$EW_USER_LEVEL_TABLE_NAME[] = 't_thongbao_mainsite';
$EW_USER_LEVEL_TABLE_VAR[] = 't_thongbao_mainsite';
$EW_USER_LEVEL_TABLE_NAME[] = 't_danhmuclich';
$EW_USER_LEVEL_TABLE_VAR[] = 't_danhmuclich';
$EW_USER_LEVEL_TABLE_NAME[] = 't_ghichu_lich';
$EW_USER_LEVEL_TABLE_VAR[] = 't_ghichu_lich';
$EW_USER_LEVEL_TABLE_NAME[] = 't_lichcongtac';
$EW_USER_LEVEL_TABLE_VAR[] = 't_lichcongtac';
$EW_USER_LEVEL_TABLE_NAME[] = 't_lichcongtac_mainsite';
$EW_USER_LEVEL_TABLE_VAR[] = 't_lichcongtac_mainsite';
$EW_USER_LEVEL_TABLE_NAME[] = 't_thongbao_mainlevel_ob';
$EW_USER_LEVEL_TABLE_VAR[] = 't_thongbao_mainlevel_ob';
$EW_USER_LEVEL_TABLE_NAME[] = 'advertising';
$EW_USER_LEVEL_TABLE_VAR[] = 'advertising';
$EW_USER_LEVEL_TABLE_NAME[] = 't_linkad';
$EW_USER_LEVEL_TABLE_VAR[] = 't_linkad';
$EW_USER_LEVEL_TABLE_NAME[] = 't_event';
$EW_USER_LEVEL_TABLE_VAR[] = 't_event';
$EW_USER_LEVEL_TABLE_NAME[] = 't_event_mainlevel';
$EW_USER_LEVEL_TABLE_VAR[] = 't_event_mainlevel';
$EW_USER_LEVEL_TABLE_NAME[] = 't_lylich';
$EW_USER_LEVEL_TABLE_VAR[] = 't_lylich';


for ($i = 0; $i < 35; $i++)
	$EW_USER_LEVEL_TABLE_CAPTION[] = ''; // Blank, use $Language object

// Dynamic Sub User Level tables
$EW_SUB_USER_LEVEL_TABLE_NAME = array();
$EW_SUB_USER_LEVEL_TABLE_CAPTION = array(); // For compatibility with PHP Report Maker 3 only

$EW_SUB_USER_LEVEL_TABLE_NAME[] = 'users';
$EW_SUB_USER_LEVEL_TABLE_VAR[] = 'users';
$EW_SUB_USER_LEVEL_TABLE_NAME[] = 'user';
$EW_SUB_USER_LEVEL_TABLE_VAR[] = 'user';
$EW_SUB_USER_LEVEL_TABLE_NAME[] = 't_nganhnghe';
$EW_SUB_USER_LEVEL_TABLE_VAR[] = 't_nganhnghe';
$EW_SUB_USER_LEVEL_TABLE_NAME[] = 't_congty';
$EW_SUB_USER_LEVEL_TABLE_VAR[] = 't_congty';
$EW_SUB_USER_LEVEL_TABLE_NAME[] = 't_danhmucgioithieu';
$EW_SUB_USER_LEVEL_TABLE_VAR[] = 't_danhmucgioithieu';
$EW_SUB_USER_LEVEL_TABLE_NAME[] = 't_danhmuctuyensinh';
$EW_SUB_USER_LEVEL_TABLE_VAR[] = 't_danhmuctuyensinh';
$EW_SUB_USER_LEVEL_TABLE_NAME[] = 't_doituong_cuusv';
$EW_SUB_USER_LEVEL_TABLE_VAR[] = 't_doituong_cuusv';
$EW_SUB_USER_LEVEL_TABLE_NAME[] = 't_doituong_doanhnghiep';
$EW_SUB_USER_LEVEL_TABLE_VAR[] = 't_doituong_doanhnghiep';
$EW_SUB_USER_LEVEL_TABLE_NAME[] = 't_doituong_svdanghoc';
$EW_SUB_USER_LEVEL_TABLE_VAR[] = 't_doituong_svdanghoc';
$EW_SUB_USER_LEVEL_TABLE_NAME[] = 't_doituong_svtuonglai';
$EW_SUB_USER_LEVEL_TABLE_VAR[] = 't_doituong_svtuonglai';
$EW_SUB_USER_LEVEL_TABLE_NAME[] = 't_htlienquan';
$EW_SUB_USER_LEVEL_TABLE_VAR[] = 't_htlienquan';
$EW_SUB_USER_LEVEL_TABLE_NAME[] = 't_chuyenmuc_levelsite';
$EW_SUB_USER_LEVEL_TABLE_VAR[] = 't_chuyenmuc_levelsite';
$EW_SUB_USER_LEVEL_TABLE_NAME[] = 't_doituong_levelsite';
$EW_SUB_USER_LEVEL_TABLE_VAR[] = 't_doituong_levelsite';
$EW_SUB_USER_LEVEL_TABLE_NAME[] = 't_tinbai_levelsite';
$EW_SUB_USER_LEVEL_TABLE_VAR[] = 't_tinbai_levelsite';
$EW_SUB_USER_LEVEL_TABLE_NAME[] = 't_tinbai_mainsite';
$EW_SUB_USER_LEVEL_TABLE_VAR[] = 't_tinbai_mainsite';
$EW_SUB_USER_LEVEL_TABLE_NAME[] = 't_tinbai_mainsite_level';
$EW_SUB_USER_LEVEL_TABLE_VAR[] = 't_tinbai_mainsite_level';
$EW_SUB_USER_LEVEL_TABLE_NAME[] = 't_thongbao_levelsite';
$EW_SUB_USER_LEVEL_TABLE_VAR[] = 't_thongbao_levelsite';
$EW_SUB_USER_LEVEL_TABLE_NAME[] = 't_thongbao_mainsite';
$EW_SUB_USER_LEVEL_TABLE_VAR[] = 't_thongbao_mainsite';
$EW_SUB_USER_LEVEL_TABLE_NAME[] = 't_danhmuclich';
$EW_SUB_USER_LEVEL_TABLE_VAR[] = 't_danhmuclich';
$EW_SUB_USER_LEVEL_TABLE_NAME[] = 't_ghichu_lich';
$EW_SUB_USER_LEVEL_TABLE_VAR[] = 't_ghichu_lich';
$EW_SUB_USER_LEVEL_TABLE_NAME[] = 't_lichcongtac';
$EW_SUB_USER_LEVEL_TABLE_VAR[] = 't_lichcongtac';
$EW_SUB_USER_LEVEL_TABLE_NAME[] = 't_lichcongtac_mainsite';
$EW_SUB_USER_LEVEL_TABLE_VAR[] = 't_lichcongtac_mainsite';
$EW_SUB_USER_LEVEL_TABLE_NAME[] = 't_thongbao_mainlevel_ob';
$EW_SUB_USER_LEVEL_TABLE_VAR[] = 't_thongbao_mainlevel_ob';
$EW_SUB_USER_LEVEL_TABLE_NAME[] = 'advertising';
$EW_SUB_USER_LEVEL_TABLE_VAR[] = 'advertising';
$EW_SUB_USER_LEVEL_TABLE_NAME[] = 't_linkad';
$EW_SUB_USER_LEVEL_TABLE_VAR[] = 't_linkad';
$EW_SUB_USER_LEVEL_TABLE_NAME[] = 't_event';
$EW_SUB_USER_LEVEL_TABLE_VAR[] = 't_event';
$EW_SUB_USER_LEVEL_TABLE_NAME[] = 't_event_mainlevel';
$EW_SUB_USER_LEVEL_TABLE_VAR[] = 't_event_mainlevel';
$EW_SUB_USER_LEVEL_TABLE_NAME[] = 't_lylich';
$EW_SUB_USER_LEVEL_TABLE_VAR[] = 't_lylich';

for ($i = 0; $i < 35; $i++)
	$EW_SUB_USER_LEVEL_TABLE_CAPTION[] = ''; // Blank, use $Language object
...
@define("EW_SUB_USER_LEVEL_TABLE", "`t_nguoidung`", TRUE);
@define("EW_SUB_USER_LEVEL_ID_FIELD", "`PK_NGUOIDUNG_ID`", TRUE);
@define("EW_SUB_USER_LEVEL_NAME_FIELD", "`C_TENDANGNHAP`", TRUE);

// User Level privileges table/field names
@define("EW_SUB_USER_LEVEL_PRIV_TABLE", "`subuserlevelpermissions`", TRUE);
@define("EW_SUB_USER_LEVEL_PRIV_TABLE_NAME_FIELD", "`tablename`", TRUE);
@define("EW_SUB_USER_LEVEL_PRIV_USER_LEVEL_ID_FIELD", "`FK_NGUOIDUNG_ID`", TRUE);
@define("EW_SUB_USER_LEVEL_PRIV_PRIV_FIELD", "`permission`", TRUE);
...
@define("EW_ALLOW_ADMIN", 31, TRUE); // Admin
...
// User table filters
define("EW_USER_NAME_FILTER", "(`C_TENDANGNHAP` = '%u')",  TRUE);
define("EW_USER_ID_FILTER", "(`PK_NGUOIDUNG_ID` = %u)",  TRUE);
define("EW_USER_EMAIL_FILTER", "(`C_EMAIL` = '%e')",  TRUE);
define("EW_USER_ACTIVATE_FILTER", "",  TRUE);
define("EW_USER_PROFILE_FIELD_NAME", "C_PROFILE",  TRUE);
...
define("EW_SMTP_SERVER_USERNAME", "hpu@hpu.edu.vn", TRUE); // SMTP server user name
define("EW_SMTP_SERVER_PASSWORD", "hpuqtm786", TRUE); // SMTP server password
define("EW_SENDER_EMAIL", "hpu@hpu.edu.vn", TRUE); // Sender email address
define("EW_RECIPIENT_EMAIL", "hpu@hpu.edu.vn", TRUE); // Recipient email address
...
define("EW_UPLOAD_ALLOWED_FILE_EXT", "swf,gif,jpg,jpeg,bmp,png,doc,docx,dotx,xls,xlsx,ppt,pptx,rtf,wmv,txt,xml,xps,pdf,zip,rar,FLV,flv,mp4,MP4,m4v,f4v,mov,VP8,WebM,MP3,aac,m4a,f4a", TRUE); // Allowed file extensions
