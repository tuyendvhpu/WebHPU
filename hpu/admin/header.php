...
<table class="HeaderLayout" cellspacing="0" cellpadding="0">
			<tr>
				...
				if (IsLoggedIn()) {
					global $Security;
                                        $url = Get_path_parent_admin ($Security->CurrentUserOption());
					echo " | Xin chào " ;                                        
                                        ?>
				...
				?>
					...
					<b>
                                            ::&nbsp;<a target="_blank" href="<?php echo $url ?>" style="text-decoration: none"><font face="Verdana" size="1" color="#003399">TRANG CHỦ</font></a>::
					<?php
					if (IsLoggedIn()==1) {
