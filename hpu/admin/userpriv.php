...
<table border="0" width="100%" id="table806" cellspacing="0" cellpadding="0">
							<tr>
								...
								<?php echo $Language->Phrase("UserLevelPermission") ?></font></b></td>
...
<a href="userlevelslist.php"><?php echo $Language->Phrase("GoBack") ?></a>
<p><span style="font-size: 14px;" class="phpmaker"><?php echo $Language->Phrase("UserLevel") ?><?php echo $Security->GetUserLevelName($userlevels->userlevelid->CurrentValue) ?>(<?php echo $userlevels->userlevelid->CurrentValue ?>)</span></p>
<?php
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
...
<table cellspacing="0" rowhighlightclass="ewTableHighlightRow" rowselectclass="ewTableSelectRow" roweditclass="ewTableEditRow" class="ewTable ewTableSeparate">
	...
	<tr class="ewTableHeader">
		...
		<td><?php echo $Language->Phrase("PermissionEdit") ?><input type="checkbox" name="Edit" id="Edit" onclick="ew_SelectAll(this);"<?php echo $userpriv->sDisabled ?>></td>
                <td><?php echo $Language->Phrase("PermissionActive") ?><input type="checkbox" name="Active" id="Active" onclick="ew_SelectAll(this);"<?php echo $userpriv->sDisabled ?>></td>
