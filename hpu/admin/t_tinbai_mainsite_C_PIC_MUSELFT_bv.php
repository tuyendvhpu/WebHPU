...
// Create page object
$t_tinbai_mainsite_C_PIC_MUSELFT_blobview = new ct_tinbai_mainsite_C_PIC_MUSELFT_blobview();
$Page =& $t_tinbai_mainsite_C_PIC_MUSELFT_blobview;

// Page init
$t_tinbai_mainsite_C_PIC_MUSELFT_blobview->Page_Init();

// Page main
$t_tinbai_mainsite_C_PIC_MUSELFT_blobview->Page_Main();
?>
<?php
$t_tinbai_mainsite_C_PIC_MUSELFT_blobview->Page_Terminate();
?>
<?php
...
// Page class
//
class ct_tinbai_mainsite_C_PIC_MUSELFT_blobview {

	// Page ID
	var $PageID = 'blobview';

	// Page object name
	var $PageObjName = 't_tinbai_mainsite_C_PIC_MUSELFT_blobview';
	...
	//
	function ct_tinbai_mainsite_C_PIC_MUSELFT_blobview() {
	...
	function Page_Main() {
		...
		$objBinary = new cUpload('t_tinbai_mainsite', 'x_C_PIC_MUSELFT');
		...
		if ($rs = $conn->Execute($sSql)) {
			if (!$rs->EOF) {
				...
				if (trim(strval($rs->fields('C_PIC_MUSELFT'))) <> "") {
					header("Content-Disposition: attachment; filename=" . $rs->fields('C_PIC_MUSELFT'));
				}
				$objBinary->Value = $rs->fields('C_PIC_MUSELFT');
