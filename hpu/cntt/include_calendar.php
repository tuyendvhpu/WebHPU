...
<div id="wrapperlich">
    ...
    <p class="plich pactive">
        <a class="atittlecalendar aactive" target="_blank" href="http://cntt.hpu.edu.vn/CNTTlich.html">  Khoa Công Nghệ Thông Tin </a><br />
    ...
    <h4> Nhóm lịch </h4>
     ...
     <h4> Tìm kiếm nhanh </h4>
                        ...
                        //   alert('The date chosen is ' + newdate);
                         window.location = "CNTTlich-ngay.html?date="+newdate+"";
                        }
                        </script>
