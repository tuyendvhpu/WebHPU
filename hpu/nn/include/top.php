              ...
              <table id="tableheader">
                     <tr>
                         ...
                         <td id="col2">  <h1 id="h1namehome"> <span class="spanlevel_home"> TRƯỜNG ĐẠI HỌC DÂN LẬP HẢI PHÒNG 
                                         <br/> <a href="../NN/NNtrangchu.html" title="Haiphong Private University - KHOA NGOẠI NGỮ">  <span class="spanlevel">KHOA NGOẠI NGỮ</span> </a>
                          ...
                          <div id="divnavi">
				              <ul id="ulnavi"> 
                                                 <?php for($i=0;$i<$rowswrk;$i++) {
                                                      $url= "NNchuyenmuc-".$arwrk[$i]['PK_CHUYENMUC']."-".changeTitle($arwrk[$i]['C_NAME']).".html";
