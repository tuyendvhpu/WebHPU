...
<script language="javascript">
       ...
       <div id="contentbody" class="clearfix">
            <div id="titlepages" style="margin:0px 7px 5px 7px;background:white">
...
?>                             
       <div clas="listcalendar" id="listcalendar">        
  <div style="border:1px #c2d4da solid;width:740px;font-family:Tahoma; box-shadow: 0 5px 5px -5px #333;">
<table style="width:740px" style="font-family:Times New Roman;font-size:12px;" BORDER=1 RULES=ALL FRAME=VOID bordercolor='#c2d4da'>
		<tr>
                    <td colspan="5">
			...
			$t_ghichu_lich->C_WEEK->EditValue = $arwrk;
               ...
               ?>
                        ...
                        <form> 
                            ...
                            <a href="../lichcongtac/HPUlich.html" title="Làm mới lịch"><img src="../images/khoa/img_refesh.jpg"><a>
                            <a title="In ấn" href="#" onclick="printform('listcalendar')"> <img src="../images/khoa/img_inan.jpg"></a>
			...
			<td colspan="4">
			   <table  style="width: 100%;height:60px" BORDER=1 RULES=ALL FRAME=VOID bordercolor='#c2d4da'>
                                 <?php
                                        ...
                                        { 
                                        // C_TITLE
                                        if ($array[$k]['C_PUBLISH'] == '1')
                                        {
                                        $tieudelich =$array[$k]['C_TITLE']." <abbr style=\"color:#FF0000\" title=\"Sự kiện dự kiến trong tuần\"> (*) </abbr>"  ;
                                        }
                                        else 
                                        {    
                                         $tieudelich =$array[$k]['C_TITLE'];
                                        }
					...
					$sFilterWrk .= "`PK_NGUOIDUNG_ID` = " . ew_AdjustSql(trim($wrk)) . "";
                     ...
                     if (($array[$k]['C_STATUS_STAR'] ==0) && ($array[$k]['C_STATUS_END'] ==0) && ($array[$k]['C_HOUR_START'] == null) && ($array[$k]['C_HOUR_END'] == null)) $t_lichcongtac->C_THOIGIAN->ViewValue1 ="Cả ngày: " ;      
                      ...
                      $url = "HPUlich-sukien-".$array[$k]['C_CADENLAR_ID'].".html";
                                ...
                                <tr>
                                    <td style="width:260px"><a class="calender_title" href="<?php echo $url ?>"> <SPAN class="spanc_thoigian"><?php echo $t_lichcongtac->C_THOIGIAN->ViewValue1 ?></SPAN>&nbsp;<?php echo  $tieudelich ?> </a></td>
                                           ...
                                           // C_ORGANIZATION
                                            ...
                                            // C_PARTICIPANTS_ID             
                                              ...
                                              <?php if (($array[$k]['C_HOUR_START'] > 12) && ($array[$k]['C_HOUR_START'] <=24))
                                                                    {  ?>
                                <tr>
                                    <td style="width:260px"><a class="calender_title" href="<?php echo $url ?>"><?php echo  $t_lichcongtac->C_THOIGIAN->ViewValue1." ".$tieudelich ?> </a></td>
                                    <td style="width:100px"><span class="spantext"> <?php echo $t_lichcongtac->C_PREPARED->ViewValue1   ?></span></td>
               ...
               <?php } ?>
                <tr>
                    <td colspan="5">
                        ...
                        $sWhereWrk = "(t_ghichu_lich.C_WEEK = '".$Week."') AND (t_ghichu_lich.C_YEAR = '".$Year."') AND (t_ghichu_lich.FK_CONGTY =151) Limit 1";
                        if ($sWhereWrk <> "") $sSqlWrk .= " WHERE $sWhereWrk";
                        $rswrk = $conn->Execute($sSqlWrk);
