...
<div id="wrapperlich">
    ...
    <p class="plich pactive">
        ...
        <a class="atittlecalendar aactive" target="_blank" href="http://ddt.hpu.edu.vn/DDTlich.html">  Khoa Điện - Điện Tử </a><br />
    ...
    <h4> Nhóm lịch </h4>
     ...
     <h4> Tìm kiếm nhanh </h4>
                        ...
                        //   alert('The date chosen is ' + newdate);
                         window.location = "DDTlich-ngay.html?date="+newdate+"";
                        }
                        </script>
