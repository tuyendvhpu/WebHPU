 ...
 <div id="layout" class="clearfix">
         ...
         <table style="width:100%">
             <tr>
                 <td>
                     ...
                     <h2 class="h2title-detail"><a href="XDhethonglienket.html"> TIỆN ÍCH </a></h2>
                    </div>
                 </td>
                 <td style="width: 50%">
       ...
       <div style="min-height: 600px;margin-top: 10px;"> 
            ...
            <td style="width: 50%;vertical-align:top; ">
                <img class="img_logo" src="anh_icon.php?text= <?php echo  $arwrk[$i]['ID'] ?>" alt="Haiphong Private University"/>
                <div>
