            ...
            <table style="width:100%">
             <tr>
                 <td>
                     ...
                     <?php  $url = "XDdoituong-".$obid."-".changeTitle($tittle_string).".html"; ?>    
                     <h2 class="h2title-detail"> <a href="<?php echo $url ?>"><?php echo $tittle_string; ?>  </a></h2>
                    </div>
                 </td>
                 <td style="width: 50%">
                     <div id="search">
                         <form action="XDdttimkiem.html" id="searchForm" method="get">
                 ...
                 <?php  if ($rowswrk >0) { ?>
                    ...
                    <ul class="ulcontents1">
                             <?php for($k=0;$k<$rowswrk;$k++) { 
                                  ...
                                  $url ="XDtintuc-".$arwrk[$k]['PK_TINBAI_ID']."-".$obid."-".$subid."-1-".changeTitle($arwrk[$k]['C_TITLE']).".html";          
                                  ?> 
                             <li> <a class="pjaxer" id="titlereport" href="<?php echo $url ?>">  <?php echo $arwrk[$k]['C_TITLE'] ?>
                                     <br>
                                     <span class="datetime"> XD - Thời gian: Creat <?php echo date( 'j/m/Y',strtotime($arwrk[$k]['C_ADD_TIME'])) ?> - <?php if ($arwrk[$k]['FK_EDITOR_ID']== -20) echo  "Authors:".$arwrk[$k]['C_HOTEN']."- BWS"; else echo  "Authors:".$arwrk[$k]['C_HOTEN']; ?> </span>
                                 </a> 
                             </li>    
                              <?php } ?>    
                      </ul>
                      ...
                      switch (strval($arwrk[$j]['C_TYPE']))   
                      {
                                       case "0":
                                                $sSqlWrk = "Select 
                                                 ...
                                                 $url_xemthem = "XDdoituong-".$arwrk[$j]['PK_DOITUONG']."-".changeTitle($arwrk[$j]['C_NAME']).".html";
                                                 break;
                                        case "2":
						$sSqlWrk = "Select 
                                                ...
                                                $url_xemthem  = "XDthongbaodt-".$arwrk[$j]['PK_DOITUONG'].".html";
                                                break;
                                 ...
                                 switch (strval($arwrk[$j]['C_TYPE']))   
                                    {
                                      case "0":
                                                ...
                                                if ($subid == null) $subid = 0;
                                                $url ="XDtintuc-".$ar[$x]['ID']."-".$obid."-".$subid."-1-".changeTitle($ar[$x]['C_TITLE']).".html";         
                                                $icon ="";
                                                break;
					case "1":
                                                $url=$ar[$x]['C_LOCATION'];
						...
						break;
                                        case "2":
                                                $url ="XDthongbao-".$ar[$x]['ID']."-".changeTitle($ar[$x]['C_TITLE']).".html"; 
                                                $icon ="";
						break;
                                    }
                             if ($ar[$x]['ID'] <> null)
