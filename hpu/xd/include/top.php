 <?php
			...
			$sWhereWrk = "FK_CONGTY =".$_SESSION['FK_CONGTY']." ORDER BY C_ORDER ASC";
              ...
              <table id="tableheader">
                     <tr>
                         ...
                         <td id="col2">  <h1 id="h1namehome"> <span class="spanlevel_home"> TRƯỜNG ĐẠI HỌC DÂN LẬP HẢI PHÒNG 
                                         <br/> <a href="../XD/XDtrangchu.html" title="Haiphong Private University - KHOA XÂY DỰNG">  <span class="spanlevel">KHOA XÂY DỰNG</span> </a>
                          ...
                          <div id="divnavi">
				              <ul id="ulnavi"> 
                                                 <?php for($i=0;$i<$rowswrk;$i++) {
                                                      $url= "XDchuyenmuc-".$arwrk[$i]['PK_CHUYENMUC']."-".changeTitle($arwrk[$i]['C_NAME']).".html";
