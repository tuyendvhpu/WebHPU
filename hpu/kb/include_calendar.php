...
<div id="wrapperlich">
     ...
     <p class="plich pactive">
        ...
        <a class="atittlecalendar aactive" target="_blank" href="http://ban.hpu.edu.vn/Khoibanlich.html">  Khối Các Ban </a><br />
    </p>
    ...
    <h4> Nhóm lịch </h4>
     ...
     <h4> Tìm kiếm nhanh </h4>
                        ...
                        window.location = "Khoibanlich-ngay.html?date="+newdate+"";
                        }
                        </script>
