                     ...
                     <tr>
				        ...
				        <a href="http://hpu.edu.vn" title="Haiphong Private University"> <img src="../images/khoa/img_logo.png" alt="Haiphong Private University"/></a></td>
                         <td id="col2">  <h1 id="h1namehome">TRƯỜNG ĐẠI HỌC DÂN LẬP HẢI PHÒNG 
                                 <br/> <a href="../kb" title="Haiphong Private University"> <span class="spanlevel"><?php echo stringname(KillChars(ew_HtmlEncode($_GET['fk_congty'])), 'C_TENCONGTY', 't_congty','PK_MACONGTY') ?></span> </a> 
                                         <br/> <span class="spandiachi"> </span> 
                         </h1></td>
                         <td id="col4">
                          <div id="divnavi">
		                      <ul id="ulnavi">
				                  <li><a href="Khoibangioithieu.html" title="Giới thiệu các phòng tại Haiphong Private University" href="home_gioithieu.php">Giới Thiệu</a></li>
                                                  <li><a href="Khoibantintuctonghop.html" title="Tin tức từ các phòng tại Haiphong Private University" href="#">Tin Tức</a></li>
				                  <li><a href="Khoibanthongbao.html" title="Thông báo từ các phòng tại Haiphong Private University" href="#">Thông Báo</a></li>
