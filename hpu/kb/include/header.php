...
<?php
 ...
 else 
 {
        ...
        $title_heder ='HPU Khối Các Ban';
        $description ='Khối Các Ban Haiphong Private University';
 } 
...
<meta property="fb:app_id" content="250208951808920" />
...
<img height="1" width="1" style="border-style:none;" alt="" src="//googleads.g.doubleclick.net/pagead/viewthroughconversion/879962061/?value=0&amp;guid=ON&amp;script=0"/>
    ...
    <?php 
        $conn = ew_Connect();
        $FK_CONGTY = 147; 
        $table1 = Check_Rootcongty(147,'PK_MACONGTY','t_congty');
