         ...
         <table style="width:100%">
             <tr>
                 <td>
                     ...
                     <h2 class="h2title-detail"> <a href="#">ĐẠI HỌC DÂN LẬP HẢI PHÒNG </a> - <a href="TT-Thongtin-Thuvientintuctonghop.html"> GIỚI THIỆU  </a></h2>
                    </div>
                 </td>
                 <td style="width: 50%">
                     <div id="search">
...
<?php
    ...
    $sWhereWrk .= "((t_tinbai_levelsite.C_TITLE LIKE '%$keyworld%')) AND ((t_doituong_levelsite.C_NAME LIKE '%Gioi thieu%')) AND (t_tinbai_mainlevel.FK_CONGTY IN ".$_SESSION['FK_CONGTY'].") AND ( t_tinbai_levelsite.C_ACTIVE=1) ORDER BY t_tinbai_mainlevel.C_ORDER DESC LIMIT $start,$rows";
