...
<link href="../css/tttt-tv.css" rel="stylesheet" type="text/css" media="screen,print" />
<link rel="stylesheet" type="text/css" href="../css/hit_tttttv.css" />
...
<?php
 ...
 else 
 {
        ...
        $title_heder ='HPU Trung tâm thông tin thư viện';
        $description ='HPU Trung tâm thông tin thư viện Haiphong Private University';
 } 
...
<meta property="fb:app_id" content="1443945792483553" />
</head>
...
<img height="1" width="1" style="border-style:none;" alt="" src="//googleads.g.doubleclick.net/pagead/viewthroughconversion/879962061/?value=0&amp;guid=ON&amp;script=0"/>
    ...
    <?php 
        $conn = ew_Connect();
        $FK_CONGTY = 117; 
        $table1 = Check_Rootcongty(117,'PK_MACONGTY','t_congty');
        $array_donvi =  (split(",",substr(str_replace (';',',',$table1),0,-1)));
        $_SESSION['ARRAY_FK_CONGTY'] = $array_donvi;
        $_SESSION['FK_CONGTY']= 117;
        $_SESSION['FK_CONGTY_EX']= "(117)";
    ?>