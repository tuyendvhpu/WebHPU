                         ...
                         $flag=  KillChars(ew_HtmlEncode($_GET['flag'],ENT_QUOTES)) ;
                          ...
                          $_SESSION['FK_CONGTY']=KillChars(ew_HtmlEncode($_GET['fk_congty'],ENT_QUOTES)) ;
                                ...
                                if (($obid <> 0))
                                {
                                    ...
                                    $url = "TT-Thongtin-Thuviendoituong-".$obid."-".changeTitle($title).".html";
                                  
                                }
                                else
                                {
                                    $title= stringname($subid,'C_NAME','t_chuyenmuc_levelsite','PK_CHUYENMUC');
                                    $url ="TT-Thongtin-Thuvienchuyenmuc-".$subid."-". $_SESSION['FK_CONGTY']."-".changeTitle($title).".html";  
                                } 
...
<div id="comment">
    <h2><span class="comentbaiviet">&#9830; Ý kiến của bạn: </span></h2>
     ...
     <div id="fb-root">
        ...
        js.src = "//connect.facebook.net/en_US/all.js#xfbml=1&appId=1443945792483553";
